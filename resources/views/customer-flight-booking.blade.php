                    ...
                    <div class="card-body user-sidebar-body">
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li>
                                        <a href="{{url('flight-booking')}}" class="fs-14 d-inline-flex align-items-center active">Flights</a>
                                    </li>
                                    <li>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('flight-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/flight/flight-09.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('flight-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/flight/flight-08.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td><a href="javascript:void(0);" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#upcoming">#FB-4581</a></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('flight-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/flight/flight-06.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td><a href="javascript:void(0);" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#pending">#FB-6545</a></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('flight-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/flight/flight-01.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td><a href="javascript:void(0);" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#cancelled">#FB-3256</a></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('flight-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/flight/flight-02.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td><a href="javascript:void(0);" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#cancelled">#FB-3654</a></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('flight-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/flight/flight-03.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td><a href="javascript:void(0);" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#completed">#FB-1458</a></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('flight-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/flight/flight-07.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td><a href="javascript:void(0);" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#completed">#FB-6589</a></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('flight-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/flight/flight-01.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td><a href="javascript:void(0);" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#completed">#FB-2315</a></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('flight-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/flight/flight-04.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td><a href="javascript:void(0);" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#completed">#FB-5414</a></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('flight-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/flight/flight-05.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
