    ...
    <div class="container">
        <div class="place-nav">
            <ul class="nav" role="tablist">
                <li>
                    <a href="javascript:void(0);" class="nav-link active" data-bs-toggle="tab" data-bs-target="#add_hotel" aria-selected="true" role="tab">
                        Edit Hotel
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);" class="nav-link" data-bs-toggle="tab" data-bs-target="#add_room" aria-selected="false" role="tab" tabindex="-1">
                        Edit Room
                    </a>
                </li>
            </ul>
                        ...
                        <form action="{{url('hotel-grid')}}">
                            ...
                            <div class="card shadow-none" id="highlights">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        <a href="javascript:void(0);" class="btn btn-primary btn-sm add-highlight"><i class="isax isax-add-circle me-1"></i>Add New</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="service-17">
                                ...
                                <div class="card-body pb-1">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-1">
                                                    <label class="form-check-label ms-2" for="accessibility-1">
                                                        Wheelchair accessible
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-2">
                                                    <label class="form-check-label ms-2" for="accessibility-2">
                                                        Visual alarms in hallways
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-3">
                                                    <label class="form-check-label ms-2" for="accessibility-3">
                                                        Elevator
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-4">
                                                    <label class="form-check-label ms-2" for="accessibility-4">
                                                        Braille/raised signage
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-5">
                                                    <label class="form-check-label ms-2" for="accessibility-5">
                                                        Roll-in shower with a bench or seat
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-6">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-7">
                                                    <label class="form-check-label ms-2" for="accessibility-7">
                                                        Wheelchair-accessible gym
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-8">
                                                    <label class="form-check-label ms-2" for="accessibility-8">
                                                        Wheelchair-accessible business center
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-9">
                                                    <label class="form-check-label ms-2" for="accessibility-9">
                                                        Wheelchair-accessible lounge
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-10">
                                                    <label class="form-check-label ms-2" for="accessibility-10">
                                                        Wheelchair-accessible concierge desk
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-11">
                                                    <label class="form-check-label ms-2" for="accessibility-11">
                                                        Lowered towel racks
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-12">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-13">
                                                    <label class="form-check-label ms-2" for="accessibility-13">
                                                        Step-free or ramped access
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-14">
                                                    <label class="form-check-label ms-2" for="accessibility-14">
                                                        Automatic doors
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-15">
                                                    <label class="form-check-label ms-2" for="accessibility-15">
                                                        Grab bars in the bathroom
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-16">
                                                    <label class="form-check-label ms-2" for="accessibility-16">
                                                        Wide doorways
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-17">
                                                    <label class="form-check-label ms-2" for="accessibility-17">
                                                        Lowered switches
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-18">
                                ...
                                <div class="card-body pb-1">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-1">
                                                    <label class="form-check-label ms-2" for="room-1">
                                                        Single Room
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-2">
                                                    <label class="form-check-label ms-2" for="room-2">
                                                        Double Room
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-3">
                                                    <label class="form-check-label ms-2" for="room-3">
                                                        Twin Room
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-4">
                                                    <label class="form-check-label ms-2" for="room-4">
                                                        Deluxe Room
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-5">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-6">
                                                    <label class="form-check-label ms-2" for="room-6">
                                                        Junior Suite
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-7">
                                                    <label class="form-check-label ms-2" for="room-7">
                                                        Family Room
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-8">
                                                    <label class="form-check-label ms-2" for="room-8">
                                                        Connecting Rooms
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-9">
                                                    <label class="form-check-label ms-2" for="room-9">
                                                        Accessible Room
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-10">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-11">
                                                    <label class="form-check-label ms-2" for="room-11">
                                                        Penthouse
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-12">
                                                    <label class="form-check-label ms-2" for="room-12">
                                                        Villa
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-13">
                                                    <label class="form-check-label ms-2" for="room-13">
                                                        Economy Room
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-14">
                                                    <label class="form-check-label ms-2" for="room-14">
                                                        City View
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="room-15">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-9">
                                                    <label class="form-check-label ms-2" for="amenities-9">
                                                        Hair Dryer
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-10">
                                                    <label class="form-check-label ms-2" for="amenities-10">
                                                        Shower
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-11">
                                                    <label class="form-check-label ms-2" for="amenities-11">
                                                        Jacuzzi/Hot Tub
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-12">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-13">
                                                    <label class="form-check-label ms-2" for="amenities-13">
                                                        Bluetooth Speaker
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-14">
                                                    <label class="form-check-label ms-2" for="amenities-14">
                                                        Sofa/Seating Area
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-15">
                            ...
                            <div class="card shadow-none" id="faq">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="card-body px-3 py-2">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <a href="javascript:void(0);" class="trash-icon d-flex align-items-center justify-content-center">
                                    ...
                                    <div>
                                        <a href="javascript:void(0);" class="btn btn-primary btn-sm add-highlight" data-bs-toggle="modal" data-bs-target="#add_faq">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="service-21">
                                                    <label class="form-check-label ms-2" for="service-21">
                                                        Concierge Services
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="service-22">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="service-26">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="service-27">
                                ...
                                <div class="card-body pb-1">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-19">
                                                    <label class="form-check-label ms-2" for="accessibility-19">
                                                        Wheelchair accessible
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-20">
                                                    <label class="form-check-label ms-2" for="accessibility-20">
                                                        Visual alarms in hallways
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-21">
                                                    <label class="form-check-label ms-2" for="accessibility-21">
                                                        Elevator
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-22">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-23">
                                                    <label class="form-check-label ms-2" for="accessibility-23">
                                                        Wheelchair-accessible gym
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-24">
                                                    <label class="form-check-label ms-2" for="accessibility-24">
                                                        Wheelchair-accessible business center
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-25">
                                                    <label class="form-check-label ms-2" for="accessibility-25">
                                                        Wheelchair-accessible lounge
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-26">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-27">
                                                    <label class="form-check-label ms-2" for="accessibility-27">
                                                        Step-free or ramped access
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-28">
                                                    <label class="form-check-label ms-2" for="accessibility-28">
                                                        Automatic doors
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="accessibility-29">
                                ...
                                <div class="card-body pb-1">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-16">
                                                    <label class="form-check-label ms-2" for="amenities-16">
                                                        Free Wi-Fi
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-17">
                                                    <label class="form-check-label ms-2" for="amenities-17">
                                                        Air Conditioning
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-18">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-19">
                                                    <label class="form-check-label ms-2" for="amenities-19">
                                                        Safe Deposit Box
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-20">
                                                    <label class="form-check-label ms-2" for="amenities-20">
                                                        Iron/Ironing Board
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-21">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-22">
                                                    <label class="form-check-label ms-2" for="amenities-22">
                                                        Bluetooth Speaker
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-23">
                                                    <label class="form-check-label ms-2" for="amenities-23">
                                                        Sofa/Seating Area
                                                    </label>
                                                </div>
                                                <div class="form-check d-flex align-items-center ps-0 mb-2">
                                                    <input class="form-check-input ms-0 mt-0" type="checkbox" id="amenities-24">
