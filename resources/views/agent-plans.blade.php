...
@component('components.breadcrumb')
  ...
  <div class="content">
    <div class="container">
        <div class="mb-3">
            <a href="{{url('agent-plans-settings')}}" class="text-primary d-inline-flex align-items-center fs-14"><i class="isax isax-arrow-left me-2"></i>Back to Plans & Billings</a>
        </div>
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card payment-details flex-fill">
                    <div class="card-header">
                    ...
                    <div class="card-body pb-1">
                        <div class="tab-pane fade active show" id="wallet">
                            ...
                            <div class="credit-card-details">
                                <div class="card-form">
                                    <h6 class="mb-3">Payment With Credit Card</h6>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="user-icon">
                                                <span class="input-icon fs-14"><i class="isax isax-eye"></i></span>
                ...
                <div class="text-end">
                    <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#payment_success">Proceed to Pay $99.00</a>
                </div>
            </div>
