            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="banner-content wow fadeInUp" data-wow-delay="0.3">
                        <h1 class="text-white display-5">Rent Luxury Cars on the Lowest Price</h1>
                        <P class="text-white">Your ultimate destination for all things help you celebrate & remember tour experience.</P>
                    </div>
...
<!-- Support Section -->
<section class="support-section bg-dark support-section-five support-three">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center g-4">
            ...
            <div class="col-lg-4 col-md-6 d-flex">
                <div class="card border-0 shadow-none pickup-card bg-secondary-100 flex-fill">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5>Flexible Pick-Up & Drop-Off</h5>
                            <span class="avatar avatar-lg bg-secondary rounded-circle flex-shrink-0 ms-3">
                                <i class="isax isax-card-coin fs-24"></i>
                            </span>
                        </div>
            ...
            <!-- Business Travel -->
            <div class="col-lg-4 col-md-6 d-flex">
                <div class="card border-0 shadow-none pickup-card bg-purple-100 flex-fill">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5>Business Travel Solutions</h5>
                            <span class="avatar avatar-lg bg-purple rounded-circle flex-shrink-0 ms-3">
                                <i class="isax isax-chart fs-24"></i>
                            </span>
                        </div>
            ...
            <!-- Pick-Up & Drop-Off -->
            <div class="col-lg-4 col-md-6 d-flex">
                <div class="card border-0 shadow-none pickup-card bg-teal-100 flex-fill">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5>Flexible Rental Periods</h5>
                            <span class="avatar avatar-lg bg-teal rounded-circle flex-shrink-0 ms-3">
                                <i class="isax isax-coin fs-24"></i>
                            </span>
                        </div>
        ...
        <div class="category-wrapper">
                ...
                <div class="col-xl-6 col-lg-10 text-center wow fadeInUp" data-wow-delay="0.2s">
                    <div class="section-header text-center">
                        <span class="car-icon mb-1">
                            <img src="{{URL::asset('build/img/icons/car-icon.svg')}}" alt="img">
                        </span>
                        <h2 class="mb-2">Trending Categories</h2>
                        <p class="sub-title">Gaining popularity due to advancements in battery technology and growing environmental awareness</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 justify-content-center">
                ...
                <!-- Category Item-->
                <div class="col">
                    <div class="category-wrap wow fadeInDown">
                        <a href="{{ url('car-details')}}" class="category-img">
                            <img src="{{URL::asset('build/img/cars/car-01.png')}}" class="img-fluid" alt="img">
                        </a>
                        <h6 class="fw-medium"><a href="{{ url('car-details')}}">Sedan</a></h6>
                    </div>
                </div>
                <!-- /Category Item-->
                ...
                <div class="col">
                    <div class="category-wrap wow fadeInDown">
                        <a href="{{ url('car-details')}}" class="category-img">
                            <img src="{{URL::asset('build/img/cars/car-02.png')}}" class="img-fluid" alt="img">
                        </a>
                        <h6 class="fw-medium"><a href="{{ url('car-details')}}">SUV</a></h6>
                    </div>
                </div>
                <!-- /Category Item-->
                ...
                <div class="col">
                    <div class="category-wrap wow fadeInDown">
                        <a href="{{ url('car-details')}}" class="category-img">
                            <img src="{{URL::asset('build/img/cars/car-03.png')}}" class="img-fluid" alt="img">
                        </a>
                        <h6 class="fw-medium"><a href="{{ url('car-details')}}">Crossover</a></h6>
                    </div>
                </div>
                <!-- /Category Item-->
                ...
                <div class="col">
                    <div class="category-wrap wow fadeInDown">
                        <a href="{{ url('car-details')}}" class="category-img">
                            <img src="{{URL::asset('build/img/cars/car-04.png')}}" class="img-fluid" alt="img">
                            <span class="badge badge-secondary">Popular</span>
                        </a>
                        <h6 class="fw-medium"><a href="{{ url('car-details')}}">Electric Vehicle</a></h6>
                    </div>
                </div>
                <!-- /Category Item-->
                ...
                <div class="col">
                    <div class="category-wrap wow fadeInDown">
                        <a href="{{ url('car-details')}}" class="category-img">
                            <img src="{{URL::asset('build/img/cars/car-05.png')}}" class="img-fluid" alt="img">
                        </a>
                        <h6 class="fw-medium"><a href="{{ url('car-details')}}">Luxury Car</a></h6>
                    </div>
                </div>
                <!-- /Category Item-->
            ...
            <div class="text-center view-all wow fadeInUp">
                <a href="{{ url('car-grid')}}" class="btn btn-dark">View All<i class="isax isax-arrow-right-3 ms-2"></i></a>
            </div>
        ...
        <div class="row align-items-center">
                    ...
                    <div class="row align-items-center gx-0">
                        <div class="col-6">
                            <div class="about-img-01">
                                <img src="{{URL::asset('build/img/cars/about-01.jpg')}}" alt="img" class="img-fluid">
                            </div>
                            <div class="about-img-03">
                                <img src="{{URL::asset('build/img/cars/about-02.jpg')}}" alt="img" class="img-fluid">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="about-img-02">
                                <img src="{{URL::asset('build/img/cars/about-03.jpg')}}" alt="img" class="img-fluid">
                            </div>
                            <div class="about-img-04">
                                <img src="{{URL::asset('build/img/cars/about-04.jpg')}}" alt="img" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <div class="about-exp">
            ...
            <div class="col-lg-6 wow fadeInDown">
                <div class="section-header mb-4">
                    <h6 class="fs-14 fw-medium text-primary d-flex align-items-center mb-2"><i class="isax isax-trend-up me-1"></i>Get to know about Us</h6>
                    <h2 class="mb-2">Provide high-quality vehicles & service to make your journeys seamless & enjoyable.</h2>
                    <p class="sub-title">We offer a diverse range of vehicles, from compact cars ideal for city driving to spacious SUVs for family trips and luxurious models for special events. All our cars are well-maintained, regularly serviced</p>
                </div>
                <div class="mb-3 border-bottom">
                    <div class="mb-3">
                        <h6 class="d-flex align-items-center"><i class="isax isax-tick-circle5 text-teal fs-24 me-2"></i>Convenient Locations</h6>
                        <p>Multiple pick-up and drop-off locations to suit your travel plans.</p>
                    </div>
                    <div class="mb-3">
                        <h6 class="d-flex align-items-center"><i class="isax isax-tick-circle5 text-orange fs-24 me-2"></i>Customer-Centric Service</h6>
                        <p>Our team is always ready to assist you with any inquiries or needs.</p>
                    </div>
                    <div class="mb-3">
                        <h6 class="d-flex align-items-center"><i class="isax isax-tick-circle5 text-purple fs-24 me-2"></i>Safety First</h6>
                ...
                <div class="d-flex align-items-center flex-wrap gap-3 mb-0 mb-md-4 mb-lg-0">
                    <a href="{{ url('add-car')}}" class="btn btn-dark d-inline-flex align-items-center"><i class="isax isax-add-circle5 me-2"></i>Add Your Car</a>
                    <a href="{{ url('car-grid')}}" class="btn btn-primary d-inline-flex align-items-center"><i class="isax isax-calendar-2 me-2"></i>Book a Car</a>
                    <div class="card border-0 mb-0">
                        <div class="card-body d-flex align-items-center">
                            <div class="avatar-list-stacked avatar-group-md me-2">
                                ...
                                <span class="avatar avatar-rounded">
                                    <img class="border border-white" src="{{URL::asset('build/img/users/user-05.jpg')}}" alt="img">
                                </span>
                                <span class="avatar avatar-rounded">
...
<section class="section place-section bg-white">
    <div class="container">
        ...
        <div class="owl-carousel cars-slider owl-dot-bottom">
...
<!-- Work Section -->
<section class="section work-section-three bg-light-200">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-12 text-center wow fadeInUp" data-wow-delay="0.2s">
                <div class="section-header text-center">
                    ...
                    <p class="sub-title">Here’s a simple breakdown of how our services work</p>
                </div>
            </div>
        </div>
        <div class="row g-4">
            <div class="col-xxl-3 col-lg-4">
                <div class="d-flex align-items-center flex-lg-row-reverse work-item gap-3 wow fadeInUp">
                    <span class="avatar avatar-lg flex-shrink-0 rounded-circle bg-primary">
                        <i class="isax isax-additem5 fs-24"></i>
                    </span>
                    <div class="text-lg-end">
                        <h6 class="fw-medium text-default mb-1">Step 1</h6>
                        <h5 class="mb-1">Choose a Rental Service</h5>
                        <p>Select a car rental company (like Hertz, Enterprise, or Budget).</p>
                    </div>
                </div>
                <div class="d-flex align-items-center flex-lg-row-reverse work-item gap-3 wow fadeInUp">
                    <span class="avatar avatar-lg flex-shrink-0 rounded-circle bg-primary">
                        <i class="isax isax-calendar-search5 fs-24"></i>
                    </span>
                    <div class="text-lg-end">
                        <h6 class="fw-medium text-default mb-1">Step 2</h6>
                        <h5 class="mb-1">Select Dates and Location</h5>
                        <p>Enter your pick-up and drop-off dates and locations.</p>
                    </div>
                </div>
                <div class="d-flex align-items-center flex-lg-row-reverse work-item gap-3 wow fadeInUp">
                    <span class="avatar avatar-lg flex-shrink-0 rounded-circle bg-primary">
                        <i class="isax isax-car5 fs-24"></i>
                    </span>
                    <div class="text-lg-end">
                        <h6 class="fw-medium text-default mb-1">Step 3</h6>
                        <h5 class="mb-1">Choose a Vehicle</h5>
                        <p>Browse available cars based on your needs (size, type, etc.).</p>
                    </div>
                </div>
            </div>
            <div class="col-xxl-6 col-lg-4 d-none d-lg-flex">
                <div class="text-center flex-fill d-flex align-items-center justify-content-center wow zoomIn" data-wow-delay="1s">
                    <div class="work-img">
                        <img src="{{URL::asset('build/img/cars/work-img.png')}}" alt="img" class="img-fluid">
                    </div>
                </div>
            </div>
            <div class="col-xxl-3 col-lg-4">
                <div class="d-flex align-items-center work-item gap-3 wow fadeInUp">
                    <span class="avatar avatar-lg flex-shrink-0 rounded-circle bg-primary">
                        <i class="isax isax-add5 fs-24"></i>
                    </span>
                    <div>
                        <h6 class="fw-medium text-default mb-1">Step 4</h6>
                        <h5 class="mb-1">Add Extras</h5>
                        <p>Consider adding insurance, GPS, or child seats if needed.</p>
                    </div>
                </div>
                <div class="d-flex align-items-center work-item gap-3 wow fadeInUp">
                    <span class="avatar avatar-lg flex-shrink-0 rounded-circle bg-primary">
                        <i class="isax isax-user-edit fs-24"></i>
                    </span>
                    <div>
                        <h6 class="fw-medium text-default mb-1">Step 5</h6>
                ...
                <div class="d-flex align-items-center work-item gap-3 wow fadeInUp">
                    ...
                    <div>
                        <h6 class="fw-medium text-default mb-1">Step 6</h6>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-10 text-center wow fadeInUp" data-wow-delay="0.2s">
                <div class="section-header text-center">
                    ...
                    <h2 class="mb-2">Popular Locations</h2>
                    <p class="sub-title">Discover the most popular locations for car rentals and find the perfect destinations to suit your travel needs.</p>
                </div>
            </div>
        </div>

        <!-- Location Slider -->
        <div class="owl-carousel location-slider owl-dot-bottom">
            <div class="location-item">
                <a href="{{ url('car-grid')}}" class="location-img">
                    <img src="{{URL::asset('build/img/destination/destination-35.jpg')}}" alt="img">
                    <div class="location-name">
                        <h5 class="mb-1">Indonesia</h5>
                        <p>(Jakarta)</p>
                    </div>
                </a>
                <div class="location-info d-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="fw-medium mb-1">28 Cars</h6>
                        <p class="fs-14">Starts From <span class="text-primary">$200</span></p>
                    </div>
                    <a href="{{ url('car-grid')}}" class="location-view"><i class="isax isax-arrow-right-3"></i></a>
                </div>
            </div>
            <div class="location-item">
                <a href="{{ url('car-grid')}}" class="location-img">
                    <img src="{{URL::asset('build/img/destination/destination-36.jpg')}}" alt="img">
                    <div class="location-name">
                        <h5 class="mb-1">Romania</h5>
                        <p>(Bucharest)</p>
                    </div>
                </a>
                <div class="location-info d-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="fw-medium mb-1">60 Cars</h6>
                        <p class="fs-14">Starts From <span class="text-primary">$300</span></p>
                    </div>
                    <a href="{{ url('car-grid')}}" class="location-view"><i class="isax isax-arrow-right-3"></i></a>
                </div>
            </div>
            <div class="location-item">
                <a href="{{ url('car-grid')}}" class="location-img">
                    <img src="{{URL::asset('build/img/destination/destination-37.jpg')}}" alt="img">
                    <div class="location-name">
                ...
                <div class="location-info d-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="fw-medium mb-1">50 Cars</h6>
                        <p class="fs-14">Starts From <span class="text-primary">$250</span></p>
                    </div>
                    <a href="{{ url('car-grid')}}" class="location-view"><i class="isax isax-arrow-right-3"></i></a>
                </div>
            </div>
            <div class="location-item">
                <a href="{{ url('car-grid')}}" class="location-img">
                    <img src="{{URL::asset('build/img/destination/destination-38.jpg')}}" alt="img">
                    <div class="location-name">
                        <h5 class="mb-1">Denmark</h5>
                        <p>(Copenhagen)</p>
                    </div>
                </a>
                <div class="location-info d-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="fw-medium mb-1">67 Cars</h6>
                        <p class="fs-14">Starts From <span class="text-primary">$400</span></p>
                    </div>
                    <a href="{{ url('car-grid')}}" class="location-view"><i class="isax isax-arrow-right-3"></i></a>
                </div>
            </div>
            <div class="location-item">
                <a href="{{ url('car-grid')}}" class="location-img">
                    <img src="{{URL::asset('build/img/destination/destination-39.jpg')}}" alt="img">
                    <div class="location-name">
                        <h5 class="mb-1">Belgium</h5>
                        <p>(Brussels)</p>
                    </div>
                </a>
                <div class="location-info d-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="fw-medium mb-1">45 Cars</h6>
                        <p class="fs-14">Starts From <span class="text-primary">$150</span></p>
                    </div>
                    <a href="{{ url('car-grid')}}" class="location-view"><i class="isax isax-arrow-right-3"></i></a>
                </div>
            </div>
            <div class="location-item">
                ...
                <div class="location-info d-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="fw-medium mb-1">12 Cars</h6>
                        <p class="fs-14">Starts From <span class="text-primary">$230</span></p>
                    </div>
                    <a href="{{ url('car-grid')}}" class="location-view"><i class="isax isax-arrow-right-3"></i></a>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="rating-feedback wow zoomIn">
                    ...
                    <ul>
                        <li>
                            <h6><i class="isax isax-global5 me-2"></i>Destinations Worldwide</h6>
                            <h4><span class="counter">50</span>+</h4>
                        </li>
                        <li>
                            <h6><i class="isax isax-calendar-2  me-2"></i>Booking Completed</h6>
                            <h4><span class="counter">7000</span> +</h4>
                        </li>
                        <li>
                            <h6><i class="isax isax-tag-user5 me-2"></i>Client Globally</h6>
                            <h4><span class="counter">100</span> +</h4>
                        </li>
                        <li>
                            <h6><i class="isax isax-status-up5 me-2"></i>Providers Registered</h6>
                            <h4><span class="counter">89</span> +</h4>
                        </li>
                    </ul>
                    <div class="bg-div">
...
<!-- Testimonial Section -->
<section class="section bg-light-200 testimonial-section-three">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-10 text-center">
                <div class="section-header text-center wow fadeInUp">
                    ...
                    <h2 class="mb-2">What’s Our User Says</h2>
                    <p class="sub-title">Committed to Helping Our Clients Succeed.</p>
                </div>
            </div>
        </div>
        <div class="owl-carousel testimonial-slider-three owl-dot-bottom">

            <!-- Testimonial Item-->
            <div class="card wow fadeInUp" data-wow-delay="0.2s">
                <div class="card-body">
                    <span class="d-block mb-3"><i class="isax isax-quote-down5 fs-30 text-primary"></i></span>
                    <div class="rating d-flex align-items-center mb-3">
                        <i class="fa-solid fa-star filled  text-warning me-1 fs-14"></i>
                        <i class="fa-solid fa-star filled  text-warning me-1 fs-14"></i>
                        <i class="fa-solid fa-star filled  text-warning me-1 fs-14"></i>
                        <i class="fa-solid fa-star filled  text-warning me-1 fs-14"></i>
                        <i class="fa-solid fa-star filled  text-warning me-1 fs-14"></i>
                        <span class="text-gray-9 fs-14 ms-1">5.0</span>
                    </div>
                    <p class="three-line-ellipsis mb-3">Dream Tours is the only way to go. We had the time of our life on our trip to the Ark. The customer service was wonderful, and the staff was very helpful.</p>
                    <div class="d-flex align-items-center border-top pt-3">
                        ...
                        <div class="ms-2 d-flex align-items-center">
                            <h6 class="fs-16 fw-medium"><a href="javascript:void(0);">Andrew</a></h6>
                            <span class="city-type">Newyork, United States</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card wow fadeInUp" data-wow-delay="0.2s">
                <div class="card-body">
                    ...
                    <p class="three-line-ellipsis mb-3">Booking our dream cruise was incredibly easy with DreamsTour The interface was user-friendly, and I loved how we could compare different cruise lines.</p>
                    <div class="d-flex align-items-center border-top pt-3">
                        <a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0">
                            <img src="{{URL::asset('build/img/users/user-02.jpg')}}" class="rounded-circle" alt="img">
                        </a>
                        <div class="ms-2 d-flex align-items-center">
                            <h6 class="fs-16 fw-medium"><a href="javascript:void(0);">Bryan</a></h6>
                            <span class="city-type">South Africa</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card wow fadeInUp" data-wow-delay="0.2s">
                <div class="card-body">
                    ...
                    <p class="three-line-ellipsis mb-3">Dream cruise was incredibly easy with DreamsTour The interface was user-friendly, and I loved how we could compare different cruise lines.</p>
                    <div class="d-flex align-items-center border-top pt-3">
                        <a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0">
                            <img src="{{URL::asset('build/img/users/user-03.jpg')}}" class="rounded-circle" alt="img">
                        </a>
                        <div class="ms-2 d-flex align-items-center">
                            <h6 class="fs-16 fw-medium"><a href="javascript:void(0);">James</a></h6>
                            <span class="city-type">South Africa</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="card wow fadeInUp" data-wow-delay="0.2s">
                <div class="card-body">
                    ...
                    <p class="three-line-ellipsis mb-3">We had a fantastic time as a family. There were activities for every age group, and the kids loved the kids’ club. The cruise gave us the relaxation and fun.</p>
                    <div class="d-flex align-items-center border-top pt-3">
                        <a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0">
                            <img src="{{URL::asset('build/img/users/user-05.jpg')}}" class="rounded-circle" alt="img">
                        </a>
                        <div class="ms-2 d-flex align-items-center">
                            <h6 class="fs-16 fw-medium"><a href="javascript:void(0);">Prajakta</a></h6>
                            <span class="city-type">France</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="testimonial-bg">
            <img src="{{URL::asset('build/img/icons/arrow.svg')}}" alt="icon" class="testimonial-icon">
        </div>
    </div>
</section>
<!-- /Testimonial Section -->
...
<!-- FAQ Section -->
<section class="faq-section-three section">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="plan-sec mb-4 mb-lg-0">
                    <div class="plan-card">
                        <div class="d-flex align-items-center justify-content-between">
                            <h2 class="text-primary mb-2">$199<span class="fs-14 fw-normal"> / Month</span></h2>
                            <a href="javascript:void(0);" class="btn btn-dark mb-2">Buy Now</a>
                        </div>
                        <h5>Basic Plan</h5>
                    ...
                    <div class="plan-card active">
                        <div class="d-flex align-items-center justify-content-between">
                            <h2 class="text-white mb-2">$399<span class="fs-14 fw-normal"> / Month</span></h2>
                            <a href="javascript:void(0);" class="btn btn-dark mb-2">Buy Now</a>
                        </div>
                        <h5>Enterprise</h5>
                        <p>Add more than 20 Cars, Get Booked around 200 Customers</p>
                    ...
                    <div class="plan-card bg-white">
                        <div class="d-flex align-items-center justify-content-between">
                            <h2 class="text-primary mb-2">$899<span class="fs-14 fw-normal"> / Month</span></h2>
                            <a href="javascript:void(0);" class="btn btn-dark mb-2">Buy Now</a>
                        </div>
                        <h5>Premium</h5>
            ...
            <div class="col-lg-6">
                <div class="section-header mb-4 wow fadeInUp" data-wow-delay="0.2s">
                    <h2 class="text-white mb-2">Start Adding Cars With Our Exclusive & Updated Pricing Plans only for you</h2>
                    <p class="text-light sub-title">Ask a Question To get Your Answers from Our DreamsTour Management</p>
                </div>
                <div class="accordion accordion-flush faq-three" id="accordionFaq">
                    <div class="accordion-item show mb-2 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div id="faq-collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionFaq">
                            <div class="accordion-body">
                                <p class="mb-0">Simply enter your location, pick-up and drop-off dates, and search through the available options. Choose the car that fits your needs, and follow the steps to complete the booking. </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="faq-bg">
        <img src="{{URL::asset('build/img/icons/circle-shape.svg')}}" alt="img" class="faq-shape">
    </div>
</section>
<!-- /FAQ Section -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-12 text-center wow fadeInUp" data-wow-delay="0.2s">
                <div class="section-header text-center">
                    ...
                    <h2 class="mb-2">Read Our Latest Stories & Tips Here</h2>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-4 col-md-6 d-flex">
                <div class="blog-item blog-wrap flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <a href="{{ url('blog-details')}}" class="blog-img">
                        <img src="{{URL::asset('build/img/blog/blog-18.jpg')}}" alt="img">
                    ...
                    <div class="blog-content">
                        ...
                        <h5><a href="{{ url('blog-details')}}">It empowers designers to swiftly created informative landing pages</a></h5>
                    </div>
                </div>
            </div>
            <!-- /Blog Item-->
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-item blog-wrap flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <a href="{{ url('blog-details')}}" class="blog-img">
                        <img src="{{URL::asset('build/img/blog/blog-19.jpg')}}" alt="img">
                    ...
                    <div class="blog-content">
                        <div class="d-flex align-items-center justify-content-between">
                            <a href="javascript:void(0);" class="d-flex align-items-center mb-2">
                                <span class="avatar avatar-md flex-shrink-0 me-2">
                                    <img src="{{URL::asset('build/img/users/user-02.jpg')}}" alt="img" class="rounded-circle">
                                </span>
                                <p class="fs-14">Harriet Collins</p>
                            </a>
                            <p class="fs-13 fw-medium d-flex align-items-center mb-2"><i class="isax isax-calendar-1 text-gray-9 fs-20 me-2"></i>27 Sep 2025</p>
                        </div>
                        <h5><a href="{{ url('blog-details')}}">Want to be notified about new post and news from our Portal ?</a></h5>
                    </div>
                </div>
            </div>
            <!-- /Blog Item-->
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-item blog-wrap flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <a href="{{ url('blog-details')}}" class="blog-img">
                        <img src="{{URL::asset('build/img/blog/blog-20.jpg')}}" alt="img">
                    ...
                    <div class="blog-content">
                        <div class="d-flex align-items-center justify-content-between">
                            <a href="javascript:void(0);" class="d-flex align-items-center mb-2">
                                <span class="avatar avatar-md flex-shrink-0 me-2">
                                    <img src="{{URL::asset('build/img/users/user-03.jpg')}}" alt="img" class="rounded-circle">
                                </span>
        ...
        <!-- Business-->
        <div class="app-wrap bg-light">
            <div class="row">
                <div class="col-lg-6 d-flex">
                    <div class="app-info flex-fill  wow fadeIn">
                        <h2 class="display-5 mb-3">Download Our App to Enjoy Unlimited Services</h2>
                        <p class="mb-3">Out App Available iin all Platforms</p>
                        <div class="d-flex align-items-center">
                            <a href="javascript:void(0);" class="me-3">
                                <img src="{{URL::asset('build/img/icons/googleplay.svg')}}" alt="img">
                            </a>
                            <a href="javascript:void(0);">
                                <img src="{{URL::asset('build/img/icons/appstore.svg')}}" alt="img">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 d-flex">
                    <div class="app-img flex-fill wow zoomIn">
                        <img src="{{URL::asset('build/img/cars/car.png')}}" alt="img">
                    </div>
                </div>
            </div>
            <div class="app-bg">
                <img src="{{URL::asset('build/img/bg/app-bg-01.png')}}" alt="img" class="app-bg-01">
                <img src="{{URL::asset('build/img/bg/app-bg-02.png')}}" alt="img" class="app-bg-02">
            </div>
        </div>
        <!-- /Business -->

        <!-- Client Section -->
        <div class="client-section-three">
            <div class="container">
