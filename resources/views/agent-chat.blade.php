        ...
        <div class="container">
            <div class="customer-chat">
                <div class="header-navigation">
                    <a href="{{url('agent-dashboard')}}" class="d-inline-flex align-items-center"><i class="isax isax-arrow-left me-2"></i>Back to Dashboard</a>
                </div>
                                                ...
                                                <div class="position-relative">
                                                    <div class="d-flex align-items-center ">
                                                        <div class="received-message me-2">
                                                            <p class="fs-14">Hi! I’m interested in booking a cruise tour. Could you help me with some details?</p>
                                                        </div>
                                                ...
                                                <div class="media-body flex-grow-1">
                                                    <div class="msg-box">
                                                        <div class="d-flex align-items-center justify-content-end mb-1">
                                                            ...
                                                            <div class="ms-2">
                                                                <img src="{{URL::asset('build/img/users/user-lg-26.jpg')}}" alt="image" class="avatar avatar-lg">
                                                            </div>
                                                        </div>
                                                        <div class="position-relative">
                                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="position-relative">
                                                    <div class="d-flex align-items-center">
                                                        <div class="received-message me-2">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <a href="javascript:void(0);"><img src="{{URL::asset('build/img/cruise/cruise-14.jpg')}}" alt="image" class="avatar avatar-xxl me-2"></a>
                                                                <a href="javascript:void(0);"><img src="{{URL::asset('build/img/cruise/cruise-29.jpg')}}" alt="image" class="avatar avatar-xxl me-2"></a>
                                                                <div class="img-count">
                                                                    <a href="javascript:void(0);"><img src="{{URL::asset('build/img/cruise/cruise-13.jpg')}}" alt="image" class="avatar avatar-xxl me-2"></a>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end">
                                                        <a href="javascript:void(0);"><span><img src="{{URL::asset('build/img/icons/thumbs-up.svg')}}" alt="image"></span></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center chat-input-icons">
                                        ...
                                        <div class="form-item emoj-action-foot">
                                            ...
                                            <div class="emoj-group-list-foot down-emoji-circle">
                                                <ul>
                                                    <li>
                                                        <a href="javascript:void(0);"><img src="{{URL::asset('build/img/icons/emonji-02.svg')}}" alt="Icon"></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);"><img src="{{URL::asset('build/img/icons/emonji-05.svg')}}" alt="Icon"></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);"><img src="{{URL::asset('build/img/icons/emonji-06.svg')}}" alt="Icon"></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);"><img src="{{URL::asset('build/img/icons/emonji-07.svg')}}" alt="Icon"></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);"><img src="{{URL::asset('build/img/icons/emonji-08.svg')}}" alt="Icon"></a>
                                                    </li>
