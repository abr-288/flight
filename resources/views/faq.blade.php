                        ...
                        <div class="col-lg-10 mx-auto">
                            <div class="accordion " id="accordionFaq">
                                ...
                                <div class="accordion-item  wow fadeInUp" data-wow-delay="1.0s">
                                    ...
                                    <div id="faq-collapseeight" class="accordion-collapse collapse" data-bs-parent="#accordionFaq">
                                        <div class="accordion-body">
                                            <p>We offer a wide range of tours, including cultural, adventure, luxury, and customized itineraries.</p>
                                        </div>
                                    </div>
            ...
            <div class="col-lg-6">
                <div class="que-sec text-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="{{url('contact-us')}}" class="btn btn-primary d-flex align-items-center justify-content-center">Contact Us<i class="isax isax-arrow-right-3 ms-1"></i></a>
                    </div>
                </div>
            </div>
        </div>
