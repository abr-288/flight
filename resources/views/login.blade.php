...
@section('content')	
 ...
 <div class="main-wrapper authentication-wrapper">
            ...
            <div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap ">
                <div class="col-xxl-4 col-lg-6 col-md-6 col-11 mx-auto">
                    <div class="p-4 text-center">
                        <img src="{{URL::asset('build/img/logo1.png')}}" alt="logo" class="img-fluid">
                    </div>
                    <div class="card authentication-card">
                        <div class="card-header">
                            <div class="text-center">
                                <h5 class="mb-1">Sign In</h5>
                                <p>Sign in to Start Manage your Conciergerie Bossiz Account</p>
                            </div>
                        </div>
                        <div class="card-body">
    ...
    <div class="coprright-footer">
        <p class="fs-14">Copyright &copy; 2025. All Rights Reserved, <a href="javascript:void(0);" class="text-primary fw-medium">Conciergerie Bossiz</a></p>
    </div>
</div>
<!-- /Main Wrapper -->
@endsection