                        ...
                        <div class="col-md-12">
                            ...
                            <div class="place-item mb-4">
                                ...
                                <div class="place-content">
                                    ...
                                    <div class="flight-loc d-flex align-items-center justify-content-between mb-3">
                                        <span class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i class="isax isax-airplane rotate-45 me-2"></i>Newyork</span>
                                        <a href="javascript:void(0);" class="arrow-icon flex-shrink-0 mx-2"><i class="isax isax-arrow-2"></i></a>
                                        <span class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i class="isax isax-airplane rotate-135 me-2"></i>Sydney</span>
                                    </div>
                            ...
                            <div class="place-item mb-4">
                                ...
                                <div class="place-content">
                                    ...
                                    <p class=" fs-14 mb-3">Enjoy a comfortable and seamless journey with top-notch service on every flight.</p>
                                    <div class="flight-loc d-flex align-items-center justify-content-between mb-3">
                                        <span class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i class="isax isax-airplane rotate-45 me-2"></i>London</span>
                                        <a href="javascript:void(0);" class="arrow-icon flex-shrink-0 mx-2"><i class="isax isax-arrow-2"></i></a>
                                        <span class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i class="isax isax-airplane rotate-135 me-2"></i>London</span>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between border-top flex-wrap gap-2 pt-3">
                                        <div class="date-info p-2">
                            ...
                            <div class="place-item mb-4">
                                ...
                                <div class="place-content">
                                    ...
                                    <p class=" fs-14 mb-3">Enjoy a hassle-free journey with reliable service, spacious seating, and friendly staff.</p>
                                    <div class="flight-loc d-flex align-items-center justify-content-between mb-3">
                                        <span class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i class="isax isax-airplane rotate-45 me-2"></i>Paris</span>
                                        <a href="javascript:void(0);" class="arrow-icon flex-shrink-0 mx-2"><i class="isax isax-arrow-2"></i></a>
                                        <span class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i class="isax isax-airplane rotate-135 me-2"></i>Cape Town</span>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between border-top flex-wrap gap-2 pt-3">
                                        <div class="date-info p-2">
                            ...
                            <div class="place-item mb-4">
                                ...
                                <div class="place-content">
                                    ...
                                    <p class=" fs-14 mb-3">Travel smart with affordable fares, seamless connections, and exceptional in-flight comfort.</p>
                                    <div class="flight-loc d-flex align-items-center justify-content-between mb-3">
                                        <span class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i class="isax isax-airplane rotate-45 me-2"></i>Toronto</span>
                                        <a href="javascript:void(0);" class="arrow-icon flex-shrink-0 mx-2"><i class="isax isax-arrow-2"></i></a>
                                        <span class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i class="isax isax-airplane rotate-135 me-2"></i>Bangkok</span>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between border-top flex-wrap gap-2 pt-3">
                                        <div class="date-info p-2">
                            ...
                            <div class="place-item mb-4">
                                ...
                                <div class="place-content">
                                    ...
                                    <p class=" fs-14 mb-3">Experience top-notch service, in-flight amenities, and smooth takeoffs for a stress-free journey.</p>
                                    <div class="flight-loc d-flex align-items-center justify-content-between mb-3">
                                        <span class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i class="isax isax-airplane rotate-45 me-2"></i>Chicago</span>
                                        <a href="javascript:void(0);" class="arrow-icon flex-shrink-0 mx-2"><i class="isax isax-arrow-2"></i></a>
                                        <span class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i class="isax isax-airplane rotate-135 me-2"></i>Melbourne</span>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between border-top flex-wrap gap-2 pt-3">
                                        <div class="date-info p-2">
                            ...
                            <div class="place-item mb-4">
                                ...
                                <div class="place-content">
                                    ...
                                    <p class=" fs-14 mb-3">Fly with confidence, knowing our comfortable cabins and efficient service make every trip a breeze.</p>
                                    <div class="flight-loc d-flex align-items-center justify-content-between mb-3">
                                        <span class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i class="isax isax-airplane rotate-45 me-2"></i>Miami</span>
                                        <a href="javascript:void(0);" class="arrow-icon flex-shrink-0 mx-2"><i class="isax isax-arrow-2"></i></a>
                                        <span class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i class="isax isax-airplane rotate-135 me-2"></i>Tokyo</span>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between border-top flex-wrap gap-2 pt-3">
                                        <div class="date-info p-2">
                            ...
                            <div class="place-item mb-4">
                                ...
                                <div class="place-content">
                                    ...
                                    <p class=" fs-14 mb-3">Relax and enjoy your flight with on-time schedules, comfortable seats, and world-class service.</p>
                                    <div class="flight-loc d-flex align-items-center justify-content-between mb-3">
                                        <span class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i class="isax isax-airplane rotate-45 me-2"></i>Frankfurt</span>
                                        <a href="javascript:void(0);" class="arrow-icon flex-shrink-0 mx-2"><i class="isax isax-arrow-2"></i></a>
                                        <span class="loc-name d-inline-flex justify-content-center align-items-center w-100"><i class="isax isax-airplane rotate-135 me-2"></i>Auckland</span>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between border-top flex-wrap gap-2 pt-3">
                                        <div class="date-info p-2">
