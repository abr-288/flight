                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="list-item d-flex align-items-center mb-3">
                                ...
                                <a href="{{ url('cruise-list')}}" class="list-icon active me-2"><i class="isax isax-firstline"></i></a>
                                    ...
                                    <div class="place-content">
                                        <div class="d-flex justify-content-between align-items-center flex-wrap row-gap-2 mb-3">
                                            <div>
                                                ...
                                                <p class="d-flex align-items-center fs-14"><i class="isax isax-location5 me-2"></i>King’s Road, Chelsea</p>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="d-flex align-items-center overflow-hidden border-end pe-2  me-2">
                                                    <span class="avatar avatar-sm flex-shrink-0 me-2">
                                        ...
                                        <p class="fs-14 line-ellipsis mb-3">Embark on a luxurious cruise where breathtaking destinations meet world-class comfort and entertainment.</p>
                                        <div class="d-flex align-items-center justify-content-between cruise-list-item border-top flex-wrap row-gap-2 pt-3 mb-3">
                                            <p class="fs-14 mb-0"><i class="isax isax-calendar-2 text-gray-6 me-1"></i>Year : <span class="text-dark fw-medium">2023</span></p>
                                            <p class="fs-14 mb-0"><i class="isax isax-user me-1"></i>Guests : <span class="text-dark fw-medium">2</span></p>
                                            <p class="fs-14 mb-0"><i class="isax isax-fatrows text-gray-6 me-1"></i>Width : <span class="text-dark fw-medium">72.83 m</span></p>
                                            <p class="fs-14"><i class="isax isax-flash-1 me-1"></i>Speed : <span class="text-dark fw-medium">23 Knots</span></p>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                            <h6 class="d-flex align-items-center"><i class="isax isax-home-wifi ms-2 me-2"></i><i class="isax isax-scissor me-2"></i><i class="isax isax-profile-2user me-2"></i><i class="isax isax-wind-2 me-2"></i><a href="javascript:void(0);" class="fs-14 fw-normal text-default d-inline-block">+2</a></h6>
                                    ...
                                    <div class="place-content">
                                        <div class="d-flex justify-content-between align-items-center flex-wrap row-gap-2 mb-3">
                                            <div>
                                                ...
                                                <p class="d-flex align-items-center fs-14"><i class="isax isax-location5 me-2"></i>Broad Street, Bristol</p>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="d-flex align-items-center overflow-hidden border-end pe-2  me-2">
                                                    <span class="avatar avatar-sm flex-shrink-0 me-2">
                                                    ...
                                                    <p class="fs-14 text-truncate">Mark Arrington</p>
                                                </a>
                                        ...
                                        <p class="fs-14 line-ellipsis mb-3">Embark on a luxurious cruise where breathtaking destinations meet world-class comfort and entertainment.</p>
                                        <div class="d-flex align-items-center justify-content-between cruise-list-item border-top flex-wrap row-gap-2 pt-3 mb-3">
                                            <p class="fs-14 mb-0"><i class="isax isax-calendar-2 text-gray-6 me-1"></i>Year : <span class="text-dark fw-medium">2018</span></p>
                                            <p class="fs-14 mb-0"><i class="isax isax-user me-1"></i>Guests : <span class="text-dark fw-medium">3</span></p>
                                            <p class="fs-14 mb-0"><i class="isax isax-fatrows text-gray-6 me-1"></i>Width : <span class="text-dark fw-medium">90.25 m</span></p>
                                            <p class="fs-14"><i class="isax isax-flash-1 me-1"></i>Speed : <span class="text-dark fw-medium">25 Knots</span></p>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                            <h6 class="d-flex align-items-center"><i class="isax isax-home-wifi ms-2 me-2"></i><i class="isax isax-scissor me-2"></i><i class="isax isax-profile-2user me-2"></i><i class="isax isax-wind-2 me-2"></i><a href="javascript:void(0);" class="fs-14 fw-normal text-default d-inline-block">+2</a></h6>
