...
@section('content')	
  ...
  <section class="hero-section">
    <div class="banner-sec banner-slider-rtl owl-carousel">
...
<section class="section destination-section">
    <div class="container">
        ...
        <div class="owl-carousel destination-sliders nav-center">
        ...
        <div class="text-center view-all wow fadeInUp">
            <a href="{{url('hotel-grid')}}" class="btn btn-dark d-inline-flex align-items-center">View All Locations<i class="isax isax-arrow-right-3 ms-2"></i></a>
        </div>
    </div>
</section>
<!-- /Destination Section -->
    ...
    <div class="container">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade active show" id="Hotels-list">
                <div class="owl-carousel place-slider-rtl nav-center" id="place-slider">

                    <!-- Place Item-->
                    <div class="place-item mb-4">
                        <div class="place-img">
                            <div class="img-slider-rtl image-slide owl-carousel nav-center">
            ...
            <div class="tab-pane fade" id="flight-list">
                <div class="owl-carousel place-slider-rtl nav-center">
                    ...
                    <div class="place-item mb-4">
                        ...
                        <div class="place-content">
                            <div class="flight-loc d-flex align-items-center justify-content-between mb-2">
                                ...
                                <a href="javascript:void(0);" class="arrow-icon"><i class="isax isax-arrow-2"></i></a>
...
<section class="section experts-section">
    <div class="container">
        ...
        <div class="owl-carousel experts-slider-rtl nav-center">
        ...
        <div class="text-center view-all wow fadeInUp">
            <a href="{{url('team')}}" class="btn btn-dark d-inline-flex align-items-center">View All Experts<i class="isax isax-arrow-right-3 ms-2"></i></a>
        </div>
    </div>
</section>
<!-- /Experts Section -->
...
<section class="section client-section">
    <div class="container">
        ...
        <div class="owl-carousel client-slider-rtl">
...
<section class="section testimonial-section">
    <div class="container">
        ...
        <div class="owl-carousel testimonial-slider-rtl">
