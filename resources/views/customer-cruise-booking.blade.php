<?php $page="customer-cruise-booking";?>
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{url('cruise-booking')}}" class="fs-14 d-inline-flex align-items-center active">Cruise</a>
                                    </li>
                                    <li>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/cruise/cruise-15.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                                    <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('cruise-details')}}">Super Aquamarine</a></p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/cruise/cruise-06.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                                    <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('cruise-details')}}">Adventure of the Seas</a></p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/cruise/cruise-05.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                                    <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('cruise-details')}}">Coral Cruiser</a></p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/cruise/cruise-12.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                                    <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('cruise-details')}}">Celebrity Cruise</a></p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/cruise/cruise-09.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                                    <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('cruise-details')}}">Princess Cruises</a></p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/cruise/cruise-12.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                                    <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('cruise-details')}}">Cunard</a></p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/cruise/cruise-25.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                                    <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('cruise-details')}}">Norwegian Cruise</a></p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/cruise/cruise-26.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                                    <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('cruise-details')}}">Azamara </a></p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/cruise/cruise-27.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                                    <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('cruise-details')}}">Costa Cruise</a></p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('cruise-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/cruise/cruise-28.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                                    <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('cruise-details')}}">Oceania Cruises</a></p>
