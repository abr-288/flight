        ...
        <div class="row">
            <div class="col-xl-8">
                ...
                <div>
                    <div class="service-wrap slider-wrap-four mb-4">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <div class="mb-2">
                                <h4 class="mb-1 d-flex align-items-center flex-wrap">Coral Cruiser<span class="badge badge-xs bg-success rounded-pill ms-2"><i class="isax isax-ticket-star me-1"></i>Verified</span></h4>
                                <div class="d-flex align-items-center flex-wrap">
                                    <p class="fs-14 mb-2 me-3 pe-3 border-end"><i class="isax isax-ship me-2"></i>Luxury Cruise</p>
                            ...
                            <div class="slider-wrap">
                                <div class="owl-carousel service-carousel nav-center mb-4" id="large-img">
                                    <div class="service-img">
                                        <img src="{{URL::asset('build/img/cruise/cruise-large-01.jpg')}}" class="img-fluid" alt="Slider Img">
                                    </div>
                                    <div class="service-img">
                                        <img src="{{URL::asset('build/img/cruise/cruise-large-02.jpg')}}" class="img-fluid" alt="Slider Img">
                                    </div>
                                    <div class="service-img">
                                        <img src="{{URL::asset('build/img/cruise/cruise-large-03.jpg')}}" class="img-fluid" alt="Slider Img">
                                    </div>
                                    <div class="service-img">
                                        <img src="{{URL::asset('build/img/cruise/cruise-large-04.jpg')}}" class="img-fluid" alt="Slider Img">
                                    </div>
                                    <div class="service-img">
                                        <img src="{{URL::asset('build/img/cruise/cruise-large-05.jpg')}}" class="img-fluid" alt="Slider Img">
                                    </div>
                                    <div class="service-img">
                                        <img src="{{URL::asset('build/img/cruise/cruise-large-06.jpg')}}" class="img-fluid" alt="Slider Img">
                                    </div>
                                </div>
                                <a href="{{URL::asset('build/img/cruise/cruise-large-03.jpg')}}" data-fancybox="gallery" class="btn btn-white btn-xs view-btn"><i class="isax isax-image me-1"></i>See All</a>
                            </div>
                            <div class="owl-carousel slider-nav-thumbnails nav-center" id="small-img">
                                <div><img src="{{URL::asset('build/img/cruise/cruise-thumb-01.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                                <div><img src="{{URL::asset('build/img/cruise/cruise-thumb-02.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                                <div><img src="{{URL::asset('build/img/cruise/cruise-thumb-03.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                                <div><img src="{{URL::asset('build/img/cruise/cruise-thumb-04.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                                <div><img src="{{URL::asset('build/img/cruise/cruise-thumb-05.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                                <div><img src="{{URL::asset('build/img/cruise/cruise-thumb-06.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion custom-accordion accordion-shadow">
                    <div class="accordion-item border-0 mb-4">
                        ...
                        <div id="accordion_collapse_two" class="accordion-collapse collapse show">
                            <div class="accordion-body">
                                ...
                                <a href="javascript:void(0);" class="fs-14 fw-medium text-decoration-underline mb-2">Show More</a>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-0 mb-4">
                                ...
                                <div class="hotel-list">
                                        ...
                                        <div class="place-content pb-1">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                <div class="overflow-hidden">
                                                    <h5 class="mb-2 d-inline-flex align-items-center text-truncate"><a href="{{ url('cruise-details')}}">Balcony</a></h5>
                                                </div>
                                            ...
                                            <div class="d-flex align-items-center flex-wrap">
                                                <p class="mb-2 d-inline-flex align-items-center fs-14"><i class="isax isax-tick-circle5 text-success me-2"></i>Butler Service</p>
                                                <p class="me-2 mb-2 d-inline-flex align-items-center fs-14"><i class="isax isax-tick-circle5 text-success me-2"></i>Laundry Services</p>
                                            </div>
                                            <div class="d-flex align-items-center flex-wrap">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                                <h5 class="text-primary me-2 mb-3">$252 <span class="text-default text-decoration-line-through">$252</span> <span class="fs-14 fw-normal text-default">/ Night ( $759 total includes taxes & fees)</span></h5>
                                    ...
                                    <div class="place-item mb-4">
                                        ...
                                        <div class="place-content pb-1">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                <div class="overflow-hidden">
                                                    <h5 class="mb-2 d-inline-flex align-items-center text-truncate"><a href="{{ url('cruise-details')}}">Ocean View</a></h5>
                                                </div>
                                                <div class="d-flex align-items-center text-nowrap mb-2">
                                                    <span class="badge badge-warning badge-xs text-gray-9 fs-13 fw-medium me-2">4.3</span>
                                                    <p class="fs-14">(380 Reviews)</p>
                                            ...
                                            <div class="d-flex align-items-center flex-wrap">
                                                <p class="me-2 mb-2 d-inline-flex align-items-center fs-14"><i class="isax isax-tick-circle5 text-success me-2"></i>Unlimited Wi-Fi</p>
                                                <p class="mb-2 d-inline-flex align-items-center fs-14"><i class="isax isax-tick-circle5 text-success me-2"></i>Private Dining</p>
                                            </div>
                                            <div class="d-flex align-items-center flex-wrap">
                                                <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2"> LED TV 2</span>
                                                <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-2"> Refrigerator</span>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                                <h5 class="text-primary me-2 mb-3">$658 <span class="text-default text-decoration-line-through">$252</span> <span class="fs-14 fw-normal text-default">/ Night ( $759 total includes taxes & fees)</span></h5>
                                                <div class="btn btn-primary btn-md mb-3">
                                                    <div class="form-check d-flex align-items-center ps-0">
                                                        <input class="form-check-input ms-0 mt-0 border border-white" name="book" type="checkbox" id="book2">
                                                        <label class="form-check-label fs-13 text-white ms-2" for="book2">Select</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="place-item mb-0">
                                        <div class="place-img">
                                            <div class="img-slider owl-carousel nav-center">
                                                <div class="slide-images">
                                                    <a href="{{ url('cruise-details')}}">
                                                        <img src="{{URL::asset('build/img/cruise/cruise-14.jpg')}}" class="img-fluid" alt="img">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="fav-item justify-content-end">
                                        ...
                                        <div class="place-content pb-1">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                <div class="overflow-hidden">
                                                    <h5 class="mb-2 d-inline-flex align-items-center text-truncate"><a href="{{ url('cruise-details')}}">Suite</a></h5>
                                                </div>
                                                <div class="d-flex align-items-center text-nowrap mb-2">
                                                    <span class="badge badge-warning badge-xs text-gray-9 fs-13 fw-medium me-2">4.3</span>
                                                    <p class="fs-14">(380 Reviews)</p>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                                ...
                                                <div class="btn btn-primary btn-md mb-3">
                                                    <div class="form-check d-flex align-items-center ps-0">
                                                        ...
                                                        <label class="form-check-label fs-13 text-white ms-2" for="book3">Select</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center flows-step">
                                        ...
                                        <div class="flow-content">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap mb-1">
                                                ...
                                                <span class="avatar avatar-lg avatar-rounded flex-shrink-0 mb-1"><img src="{{URL::asset('build/img/tours/tours-16.jpg')}}" alt="Img"></span>
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center flows-step">
                                        ...
                                        <div class="flow-content">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap mb-1">
                                                ...
                                                <span class="avatar avatar-lg avatar-rounded flex-shrink-0 mb-1"><img src="{{URL::asset('build/img/tours/tours-17.jpg')}}" alt="Img"></span>
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center flows-step">
                                        ...
                                        <div class="flow-content">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap mb-1">
                                                ...
                                                <span class="avatar avatar-lg avatar-rounded flex-shrink-0 mb-1"><img src="{{URL::asset('build/img/tours/tours-18.jpg')}}" alt="Img"></span>
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center flows-step">
                                        ...
                                        <div class="flow-content">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap mb-1">
                                                ...
                                                <span class="avatar avatar-lg avatar-rounded flex-shrink-0 mb-1"><img src="{{URL::asset('build/img/tours/tours-19.jpg')}}" alt="Img"></span>
                                            </div>
                                            <p>
                        ...
                        <div id="accordion_collapse_four" class="accordion-collapse collapse show">
                            <div class="accordion-body">
                                <div class="row row-cols-lg-6 row-cols-sm-4 row-cols-2 g-2">
                                    <div class="col">
                                        <a class="galley-wrap" data-fancybox="gallery" href="{{URL::asset('build/img/cruise/cruise-large-01.jpg')}}">
                                            <img src="{{URL::asset('build/img/cruise/cruise-thumb-01.jpg')}}" alt="img">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="galley-wrap" data-fancybox="gallery" href="{{URL::asset('build/img/cruise/cruise-large-02.jpg')}}">
                                            <img src="{{URL::asset('build/img/cruise/cruise-thumb-02.jpg')}}" alt="img">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="galley-wrap" data-fancybox="gallery" href="{{URL::asset('build/img/cruise/cruise-large-03.jpg')}}">
                                            <img src="{{URL::asset('build/img/cruise/cruise-thumb-03.jpg')}}" alt="img">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="galley-wrap" data-fancybox="gallery" href="{{URL::asset('build/img/cruise/cruise-large-04.jpg')}}">
                                            <img src="{{URL::asset('build/img/cruise/cruise-thumb-04.jpg')}}" alt="img">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="galley-wrap" data-fancybox="gallery" href="{{URL::asset('build/img/cruise/cruise-large-05.jpg')}}">
                                            <img src="{{URL::asset('build/img/cruise/cruise-thumb-05.jpg')}}" alt="img">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <div class="galley-wrap more-gallery d-flex align-items-center justify-content-center">
                                            <a data-fancybox="gallery" href="{{URL::asset('build/img/cruise/cruise-large-04.jpg')}}" class="btn btn-white btn-xs"><i class="isax isax-image5 me-1"></i>See All</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-body">
                                <div class="position-relative">
                                    <a href="javascript:void(0);">
                                        <img src="{{URL::asset('build/img/cruise/cruise-large-03.jpg')}}" class="rounded" alt="Img">
                                    </a>
                    ...
                    <div class="accordion-item mb-4 mb-xl-0 border-0" id="reviews">
                        <div class="accordion-header">
                                    ...
                                    <div class="card review-item shadow-none mb-3">
                                        <div class="card-body p-3">
                                            <div class="review-info">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <a class="avatar avatar-md me-2 mb-2" data-fancybox="gallery" href="{{URL::asset('build/img/cruise/cruise-large-02.jpg')}}">
                                                        <img src="{{URL::asset('build/img/cruise/cruise-thumb-02.jpg')}}" alt="img">
                                                    </a>
                                                    <a class="avatar avatar-md me-2 mb-2" data-fancybox="gallery" href="{{URL::asset('build/img/cruise/cruise-large-03.jpg')}}">
                                                        <img src="{{URL::asset('build/img/cruise/cruise-thumb-03.jpg')}}" alt="img">
                                                    </a>
                                                    <a class="avatar avatar-md me-0 mb-2" data-fancybox="gallery" href="{{URL::asset('build/img/cruise/cruise-large-01.jpg')}}">
                                                        <img src="{{URL::asset('build/img/cruise/cruise-thumb-01.jpg')}}" alt="img">
                                                    </a>
                                                </div>
                ...
                <div class="card bg-light-200">
                    <div class="card-body">
                        <h5 class="d-flex align-items-center fs-18 mb-3">
                            <span class="avatar avatar-md rounded-circle bg-primary me-2"><i class="isax isax-ship5"></i></span>
                            Cruise Information
                        </h5>
                        <div>
                            <div class="d-flex align-items-center justify-content-between details-info">
                                <h6 class="fw-medium">Launched On</h6>
                                <p class="flex-fill">25 May 2025</p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between details-info">
                                <h6 class="fw-medium">Length</h6>
                                <p class="flex-fill">35 M</p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between details-info">
                                <h6 class="fw-medium">Staffs</h6>
                                <p class="flex-fill">200</p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between details-info">
                                <h6 class="fw-medium">Beam</h6>
                                <p class="flex-fill">200 ft</p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between details-info">
                                <h6 class="fw-medium">Weight</h6>
                                <p class="flex-fill">8000 grt</p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between details-info">
                                <h6 class="fw-medium">Dining Crew</h6>
                                <p class="flex-fill">80</p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between details-info">
                                <h6 class="fw-medium">Speed</h6>
                                <p class="flex-fill">80.6 knots</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card shadow-none">
                    <div class="card-body">
                        ...
                        <div class="banner-form">
                            <form action="{{ url('cruise-booking')}}" class="form-info border-0">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-1">
                                    <h6 class="fs-14 fw-medium text-success">3 Cabin Available on your Search</h6>
                                    <a href="#accordion_collapse_six" class="link-primary text-decoration-underline fs-14">View Cabins</a>
                                </div>
                            </form>
                        </div>
                    </div>
