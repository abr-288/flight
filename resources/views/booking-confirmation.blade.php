							...
							<div class="bg-light-200 border border-light p-3 rounded-2 mb-4">
								<div class="d-flex flex-wrap align-items-center justify-content-between ">
									<div class="d-flex flex-wrap align-items-center booking-hotels">
										<a href="{{ url('hotel-details')}}" class="avatar avatar-lg me-2">
											<img src="{{URL::asset('build/img/hotels/hotel-06.jpg')}}" alt="image" class="img-fluid  rounded-circle">
										</a>
										<div class="booking-details">
											<h6 class="mb-1"><a href="{{ url('hotel-details')}}">The Luxe Haven</a></h6>
											<div class="d-flex flex-wrap align-items-center booking-items">
												<p class="fs-14 text-gray-6 pe-2 border-end border-light d-flex align-items-center me-2 ">
													<i class="isax isax-buildings me-1"></i>Luxury Hotel
												</p>
												<p class="fs-14 text-gray-6 pe-2 border-end border-light d-flex align-items-center me-2 ">
							...
							<div class="pb-4 border-bottom mb-4">
								...
								<div class="row g-3">
									<div class="col-lg-3">
										...
										<p class="fs-16 text-gray-6">Queen Room</p>
									</div>
									<div class="col-lg-3">
										<h6 class="fs-14 mb-1">No of Rooms</h6>
										<p class="fs-16 text-gray-6">1</p>
									</div>
									<div class="col-lg-3">
										<h6 class="fs-14 mb-1">Room Price</h6>
										<p class="fs-16 text-gray-6">$400</p>
									</div>
									<div class="col-lg-3">
										<h6 class="fs-14 mb-1">Guests</h6>
										<p class="fs-16 text-gray-6">4 Adults, 2 Child</p>
									</div>
								</div>
							</div>
							<div class="pb-4 border-bottom mb-4">
								...
								<div class="row g-3">
									<div class="col-lg-3">
										...
										<p class="fs-16 text-gray-6">15 May 2024</p>
									</div>
									<div class="col-lg-3">
										<h6 class="fs-14 mb-1">Check In Date & Time</h6>
										<p class="fs-16 text-gray-6">20 May 2024, 10:50 AM</p>
									</div>
									<div class="col-lg-3">
										<h6 class="fs-14 mb-1">Checkout Date & Time</h6>
										<p class="fs-16 text-gray-6">25 May 2024, 10:50 AM</p>
									</div>
									<div class="col-lg-3">
										<h6 class="fs-14 mb-1">No of Days Stay</h6>
										<p class="fs-16 text-gray-6">4 Days, 5 Nights</p>
									</div>
								</div>
							</div>
							<div class="pb-4 border-bottom mb-4">
								...
								<div class="d-flex flex-wrap align-items-center service-info gap-3">
									<span class="badge badge-light rounded-pill">Cleaning</span>
									<span class="badge badge-light rounded-pill">Airport Pickup</span>
									<span class="badge badge-light rounded-pill">Breakfast</span>
								</div>
							</div>
							<div class="pb-4 border-bottom mb-4">
								...
								<div class="row g-3">
									<div class="col-lg-3">
										...
										<p class="fs-16 text-gray-6">Chris Foxy</p>
									</div>
									<div class="col-lg-3">
										<h6 class="fs-14 mb-1">Email</h6>
										<p class="fs-16 text-gray-6">chrfo2356@example.com</p>
									</div>
									<div class="col-lg-3">
										<h6 class="fs-14 mb-1">Phone</h6>
										<p class="fs-16 text-gray-6">+1 12656 26654</p>
									</div>
									<div class="col-lg-3">
										<h6 class="fs-14 mb-1">Address</h6>
										<p class="fs-16 text-gray-6">15/C Prince Road, New York</p>
									</div>
								</div>
							</div>
							<div>
								...
								<div class="row g-3">
									<div class="col-lg-3">
										...
										<p class="fs-16 text-primary">#45669</p>
									</div>
									<div class="col-lg-3">
										<h6 class="fs-14 mb-1">Payment Method</h6>
										<p class="fs-16 text-gray-6">Credit Card (Visa)</p>
									</div>
									<div class="col-lg-3">
										<h6 class="fs-14 mb-1">Payment Status</h6>
										<p class="fs-16 text-success">Paid</p>
									</div>
									<div class="col-lg-3">
									...
									<div class="col-lg-3">
										...
										<p class="fs-16 text-gray-6">15% ($60)</p>
									</div>
									<div class="col-lg-3">
										<h6 class="fs-14 mb-1">Discount</h6>
										<p class="fs-16 text-gray-6">20% ($15)</p>
									</div>
									<div class="col-lg-3">
										<h6 class="fs-14 mb-1">Booking Fees</h6>
										<p class="fs-16 text-gray-6">$25</p>
									</div>
									<div class="col-lg-3">
										<h6 class="fs-14 mb-1">Total Paid</h6>
										<p class="fs-16 text-gray-6">$6569</p>
									</div>
								</div>
							</div>
						</div>
