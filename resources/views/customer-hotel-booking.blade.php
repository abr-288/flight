                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{url('hotel-booking')}}" class="fs-14 d-inline-flex align-items-center active">Hotels</a>
                                    </li>
                                    <li>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('hotel-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/hotels/hotel-21.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('hotel-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/hotels/hotel-model-05.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('hotel-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/hotels/hotel-23.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('hotel-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/hotels/hotel-13.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{url('hotel-details')}}" class="avatar avatar-lg"><img src="{{URL::asset('build/img/hotels/hotel-24.jpg')}}" class="img-fluid rounded-circle" alt="img"></a>
                                                <div class="ms-2">
