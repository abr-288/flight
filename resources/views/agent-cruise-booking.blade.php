                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{url('agent-cruise-booking')}}" class="fs-14 d-inline-flex align-items-center active">Cruise</a>
                                    </li>
                                    <li>
            ...
            <div class="col-xl-9 col-lg-8 theiaStickySidebar">
                ...
                <div class="card booking-header border-0">
                    <div class="card-body header-content d-flex align-items-center justify-content-between flex-wrap ">
                        <div>
                            <h6 class="mb-1">Cruise Bookings</h6>
                        ...
                        <div class="custom-datatable-filter table-responsive">
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="javascript:void(0);" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#upcoming">#CR-6545</a></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                    ...
                                    <tr>
                                        <td><a href="javascript:void(0);" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#upcoming">#CR-3256</a></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
