                    ...
                    <div class="card-body">
                        <div class="bg-light-200 border border-light p-3 rounded-2 mb-4">
                            <div class="d-flex flex-wrap align-items-center justify-content-between ">
                                <div class="d-flex flex-wrap align-items-center booking-hotels">
                                    <a href="{{url('flight-details')}}" class="avatar avatar-lg me-2">
                                        <img src="{{URL::asset('build/img/flight/flight-01.jpg')}}" alt="image" class="img-fluid  rounded-circle">
                                    </a>
                                    <div class="booking-details">
                                        <h6 class="mb-1"><a href="{{url('flight-details')}}">AstraFlight 215</a></h6>
                                        <div class="d-flex flex-wrap align-items-center booking-items">
                                            <p class="fs-14 text-gray-6 pe-2 border-end border-light d-flex align-items-center me-2 ">
                                                <img src="{{URL::asset('build/img/icons/airindia.svg')}}" alt="image" class="avatar avatar-sm avatar-rounded me-2">Air India
                                            </p>
                                            <p class="fs-14 text-gray-6 pe-2 border-end border-light d-flex align-items-center me-2 ">
                                                <i class="isax isax-location5 me-1"></i>15/C Prince Dareen Road, New York
                                            </p>
                                            <p class="fs-14 text-gray-6 pe-2 border-end border-light d-flex align-items-center me-2 ">
                        ...
                        <div class="pb-4 border-bottom mb-4">
                            ...
                            <div class="d-flex flex-wrap align-items-center service-info gap-3">
                                <span class="badge badge-light rounded-pill">Blankets & Pillows</span>
                            </div>
                        </div>
                        <div class="pb-4 border-bottom mb-4">
                            <h6 class="mb-2">Meals Plan</h6>
                            <div class="d-flex flex-wrap align-items-center service-info gap-3">
                                <span class="badge badge-light rounded-pill">Lunch</span>
                                <span class="badge badge-light rounded-pill">Dinner</span>
                            </div>
                        </div>
                        <div class="pb-4 border-bottom mb-4">
