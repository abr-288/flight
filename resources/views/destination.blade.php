    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <!-- Destination Item-->
                <div class="destination-item wow fadeInUp" data-wow-delay="0.2s">
                    <img src="{{URL::asset('build/img/destination/destination-40.jpg')}}" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                            <h5 class="mb-1 text-white">Azerbaijan</h5>
                            <div class="d-flex align-items-center justify-content-center">
                                <div class="rating d-flex align-items-center me-2">
                                    <i class="fa-solid fa-star filled me-1"></i>
                                    <i class="fa-solid fa-star filled me-1"></i>
                                ...
                                <p class="fs-14 text-white">340 Reviews</p>
                            </div>
                        </div>
                        <div class="destination-overlay bg-white mt-2">
                            <div class="d-flex">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <!-- Destination Item-->
                <div class="destination-item wow fadeInUp" data-wow-delay="0.2s">
                    <img src="{{URL::asset('build/img/destination/destination-41.jpg')}}" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                            <h5 class="mb-1 text-white">Russia</h5>
                            <div class="d-flex align-items-center justify-content-center">
                                <div class="rating d-flex align-items-center me-2">
                                    <i class="fa-solid fa-star filled me-1"></i>
                                    <i class="fa-solid fa-star filled me-1"></i>
                                ...
                                <p class="fs-14 text-white">410 Reviews</p>
                            </div>
                        </div>
                        <div class="destination-overlay bg-white mt-2">
                            <div class="d-flex">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <!-- Destination Item-->
                <div class="destination-item wow fadeInUp" data-wow-delay="0.2s">
                    <img src="{{URL::asset('build/img/destination/destination-42.jpg')}}" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                            <h5 class="mb-1 text-white">Indonesia</h5>
                            <div class="d-flex align-items-center justify-content-center">
                                <div class="rating d-flex align-items-center me-2">
                                    <i class="fa-solid fa-star filled me-1"></i>
                                    <i class="fa-solid fa-star filled me-1"></i>
                                ...
                                <p class="fs-14 text-white">280 Reviews</p>
                            </div>
                        </div>
                        <div class="destination-overlay bg-white mt-2">
                            <div class="d-flex">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <!-- Destination Item-->
                <div class="destination-item wow fadeInUp" data-wow-delay="0.2s">
                    <img src="{{URL::asset('build/img/destination/destination-43.jpg')}}" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                            <h5 class="mb-1 text-white">Belgium </h5>
                            <div class="d-flex align-items-center justify-content-center">
                                <div class="rating d-flex align-items-center me-2">
                                    <i class="fa-solid fa-star filled me-1"></i>
                                    <i class="fa-solid fa-star filled me-1"></i>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <!-- Destination Item-->
                <div class="destination-item wow fadeInUp" data-wow-delay="0.2s">
                    <img src="{{URL::asset('build/img/destination/destination-44.jpg')}}" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                            <h5 class="mb-1 text-white">Denmark</h5>
                            <div class="d-flex align-items-center justify-content-center">
                                <div class="rating d-flex align-items-center me-2">
                                    <i class="fa-solid fa-star filled me-1"></i>
                                    <i class="fa-solid fa-star filled me-1"></i>
                                ...
                                <p class="fs-14 text-white">460 Reviews</p>
                            </div>
                        </div>
                        <div class="destination-overlay bg-white mt-2">
                            <div class="d-flex">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <!-- Destination Item-->
                <div class="destination-item wow fadeInUp" data-wow-delay="0.2s">
                    <img src="{{URL::asset('build/img/destination/destination-45.jpg')}}" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                            <h5 class="mb-1 text-white">Germany</h5>
                            <div class="d-flex align-items-center justify-content-center">
                                <div class="rating d-flex align-items-center me-2">
                                    <i class="fa-solid fa-star filled me-1"></i>
                                    <i class="fa-solid fa-star filled me-1"></i>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <!-- Destination Item-->
                <div class="destination-item wow fadeInUp" data-wow-delay="0.2s">
                    <img src="{{URL::asset('build/img/destination/destination-46.jpg')}}" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <p class="fs-14 text-white">550 Reviews</p>
                            </div>
                        </div>
                        <div class="destination-overlay bg-white mt-2">
                            <div class="d-flex">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <!-- Destination Item-->
                <div class="destination-item wow fadeInUp" data-wow-delay="0.2s">
                    <img src="{{URL::asset('build/img/destination/destination-47.jpg')}}" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                            <h5 class="mb-1 text-white">Japan</h5>
                            <div class="d-flex align-items-center justify-content-center">
                                <div class="rating d-flex align-items-center me-2">
                                    <i class="fa-solid fa-star filled me-1"></i>
                                    <i class="fa-solid fa-star filled me-1"></i>
                                ...
                                <p class="fs-14 text-white">580 Reviews</p>
                            </div>
                        </div>
                        <div class="destination-overlay bg-white mt-2">
                            <div class="d-flex">
