        ...
        <div class="slider-wrap home-vertical-slider">
            ...
            <div class="">
                <div class="slider-nav nav-center" id="small-img">
                    <div><img src="{{URL::asset('build/img/hotels/hotel-slider-thumb-01.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                    <div><img src="{{URL::asset('build/img/hotels/hotel-slider-thumb-02.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                    <div><img src="{{URL::asset('build/img/hotels/hotel-slider-thumb-03.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                    <div><img src="{{URL::asset('build/img/hotels/hotel-slider-thumb-04.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-12 mx-auto wow fadeInUp" data-wow-delay="0.3s">
                    <div class="banner-content text-start">
                        <h1 class="text-white display-5 mb-2">Experience the Magic: Exclusive Offers from DreamsTour</h1>
...
<section class="section traveling-sec">
    ...
    <div class="container">
        <div class="section-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
            <div>
                <p class="mb-2 fw-medium d-flex align-items-center"><span class="text-bar"></span>Featured Categories</p>
                <h2>Travelers & Preferences<span class="text-primary">.</span></h2>
            </div>
            <div>
                <a href="{{url('hotel-grid')}}" class="btn btn-primary">View All<i class="isax isax-arrow-right-3 ms-2"></i></a>
            </div>
        </div>
        <div class="travelers-slider owl-carousel">
            <div class="card travelers-card">
                <div class="card-img">
                    <a href="{{url('hotel-grid')}}"><img src="{{URL::asset('build/img/hotels/hotel-25.jpg')}}" class="rounded-top" alt="Img"></a>
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <a href="{{url('hotel-grid')}}" class="rounded-arrow-next"><i class="isax isax-arrow-right-3"></i></a>
                    </div>
                </div>
            </div>
            <div class="card travelers-card">
                <div class="card-img">
                    <a href="{{url('hotel-grid')}}"><img src="{{URL::asset('build/img/hotels/hotel-26.jpg')}}" class="rounded-top" alt="Img"></a>
            ...
            <div class="card travelers-card">
                <div class="card-img">
                    <a href="{{url('hotel-grid')}}"><img src="{{URL::asset('build/img/hotels/hotel-27.jpg')}}" class="rounded-top" alt="Img"></a>
            ...
            <div class="card travelers-card">
                <div class="card-img">
                    <a href="{{url('hotel-grid')}}"><img src="{{URL::asset('build/img/hotels/hotel-28.jpg')}}" class="rounded-top" alt="Img"></a>
            ...
            <div class="card travelers-card">
                <div class="card-img">
                    <a href="{{url('hotel-grid')}}"><img src="{{URL::asset('build/img/hotels/hotel-29.jpg')}}" class="rounded-top" alt="Img"></a>
...
<section class="section benifit-section bg-light-200">
    <div class="container">
        <div class="section-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
            ...
            <div>
                <a href="{{url('hotel-grid')}}" class="btn btn-primary">View All Hotels<i class="isax isax-arrow-right-3 ms-2"></i></a>
            </div>
        </div>
        <div class="place-slider owl-carousel">
            <div class="place-item mb-4 flex-fill">
                ...
                <div class="place-content">
                    ...
                    <div class="border-top pt-2 mb-2">
                        <h6 class="d-flex align-items-center">Facillities :<i class="isax isax-home-wifi ms-2 me-2 text-primary"></i><i class="isax isax-scissor me-2 text-primary"></i><i class="isax isax-profile-2user me-2 text-primary"></i><i class="isax isax-wind-2 me-2 text-primary"></i><a href="javascript:void(0);" class="fs-14 fw-normal text-default d-inline-block">+2</a></h6>
                    </div>
            ...
            <div class="place-item mb-4 flex-fill">
                ...
                <div class="place-content">
                    ...
                    <div class="d-flex align-items-center justify-content-between border-top pt-3">
                        <h5 class="text-primary text-nowrap me-2">$300 <span class="fs-14 fw-normal text-default">/ Night</span></h5>
                        <a href="javascript:void(0);" class="d-flex align-items-center overflow-hidden">
                            <span class="avatar avatar-md flex-shrink-0 me-2">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 col-10">
                        <div>
                            ...
                            <a href="{{url('hotel-list')}}" class="btn btn-white text-dark">Explore All Offers<i class="isax isax-arrow-right-3 ms-2"></i></a>
        ...
        <div class="popular-hotels">
            ...
            <div class="popular-hotel-slider owl-carousel">
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                            <a href="{{url('hotel-details')}}" class="flex-shrink-0 me-3"><img src="{{URL::asset('build/img/icons/hotel-logo-01.svg')}}" class="rounded-circle" alt="Img"></a>
                            <div>
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                            <a href="{{url('hotel-details')}}" class="flex-shrink-0 me-3"><img src="{{URL::asset('build/img/icons/hotel-logo-02.svg')}}" class="rounded-circle" alt="Img"></a>
                            <div>
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                            <a href="{{url('hotel-details')}}" class="flex-shrink-0 me-3"><img src="{{URL::asset('build/img/icons/hotel-logo-03.svg')}}" class="rounded-circle" alt="Img"></a>
                            <div>
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                            <a href="{{url('hotel-details')}}" class="flex-shrink-0 me-3"><img src="{{URL::asset('build/img/icons/hotel-logo-04.svg')}}" class="rounded-circle" alt="Img"></a>
                            <div>
...
<section class="section">
    <div class="container">
        <div class="section-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
            <div>
                <p class="mb-2 fw-medium d-flex align-items-center"><span class="text-bar"></span>Popular Destinations</p>
                <h2>Travelers & Preferences<span class="text-primary">.</span></h2>
            </div>
            <div>
                <a href="{{url('hotel-grid')}}" class="btn btn-primary">View All<i class="isax isax-arrow-right-3 ms-2"></i></a>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div>
                    ...
                    <div class="d-flex align-items-center">
                        <a href="{{url('add-hotel')}}" class="btn btn-dark me-3"><i class="isax isax-add-circle5 me-2"></i>Add Your Hotel</a>
                        <a href="{{url('hotel-grid')}}" class="btn btn-primary"><i class="isax isax-calendar5 me-2"></i>Book a Hotel</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-xxl-3 col-lg-4">
                <div class="section-header">
                    <div>
                        <p class="mb-2 fw-medium d-flex align-items-center text-white"><span class="text-bar bg-white"></span>How it Works</p>
...
<section class="section testimonial-section testi-sec-two bg-white">
    ...
    <div class="container">
        <div class="section-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
            <div>
                <p class="mb-2 fw-medium d-flex align-items-center"><span class="text-bar"></span>What’s Our User Says</p>
                <h2>Committed to Helping Our Clients Succeed<span class="text-primary">.</span></h2>
            </div>
            <div>
                <a href="{{url('testimonial')}}" class="btn btn-primary">View All<i class="isax isax-arrow-right-3 ms-2"></i></a>
            </div>
        </div>
        <div class="owl-carousel testimonial-slider">
            ...
            <div class="card border-white wow fadeInUp" data-wow-delay="0.2s">
                <div class="card-body text-center">
                    ...
                    <h6 class="mb-1">Easy to Find your Leisuere Place</h6>
                    <p class="mb-3">I went on the Gone with the Wind tour, and it was my first multi-day bus tour. The experience was terrific, thanks to the friendly tour guides. I’ve told many people about it</p>
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0);" class="avatar avatar-md  flex-shrink-0">
            ...
            <div class="card border-white wow fadeInUp" data-wow-delay="0.2s">
                <div class="card-body text-center">
                    ...
                    <h6 class="mb-1">Easy to Find your Leisuere Place</h6>
                    <p class="mb-3">Thanks for arranging a smooth travel experience for us. Our cab driver was polite, timely, and helpful. The team ensured that everything was taken care of, making it a stress-free trip</p>
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0);" class="avatar avatar-md  flex-shrink-0">
        ...
        <div class="faq-secpath-two">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="section-header">
                        <div>
                            <p class="mb-2 fw-medium d-flex align-items-center"><span class="text-bar"></span>Frequently Asked Questions</p>
...
<section class="section blog-sec-two pt-0">
    <div class="container">
        <div class="section-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
            <div>
                <p class="mb-2 fw-medium d-flex align-items-center"><span class="text-bar"></span>Latest Articles</p>
                <h2>Stay Updated on the Stories<span class="text-primary">.</span></h2>
            </div>
            <div>
                <a href="{{url('blog-grid')}}" class="btn btn-primary">View All<i class="isax isax-arrow-right-3 ms-2"></i></a>
            </div>
        </div>
        <div class="blog-slider owl-carousel">
            ...
            <div class="card blog-grid wow fadeInUp" data-wow-delay="0.2s">
                ...
                <div class="card-body">
                    <h5 class="mb-3"><a href="{{url('blog-details')}}" class="two-line-ellipsis">It empowers designers to swiftly created informative landing pages</a></h5>
                    <div class="d-flex align-items-center justify-content-between">
                        <a href="javascript:void(0);" class="d-flex align-items-center overflow-hidden">
                            <span class="avatar avatar-md flex-shrink-0 me-2">
                                <img src="{{URL::asset('build/img/users/user-01.jpg')}}" class="rounded-circle" alt="img">
                        ...
                        <a href="{{url('blog-details')}}" class="rounded-arrow-next"><i class="isax isax-arrow-right-3"></i></a>
                    </div>
                </div>
            </div>
            <!-- /Blog Item-->
            ...
            <div class="card blog-grid wow fadeInUp" data-wow-delay="0.2s">
                ...
                <div class="card-body">
                    <h5 class="mb-3"><a href="{{url('blog-details')}}" class="two-line-ellipsis">Want to be notified about new post and news from our Portal ?</a></h5>
                    <div class="d-flex align-items-center justify-content-between">
                        <a href="javascript:void(0);" class="d-flex align-items-center overflow-hidden">
                            <span class="avatar avatar-md flex-shrink-0 me-2">
                                <img src="{{URL::asset('build/img/users/user-02.jpg')}}" class="rounded-circle" alt="img">
