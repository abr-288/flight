                ...
                <div class="card payment-details">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-end flex-wrap gap-2">
                            <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#booking-success">Confirm & Pay $9569 </a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card order-details">
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between header-content">
                            ...
                            <a href="{{url('car-details')}}" class="rounded-circle p-2 btn btn-light d-flex align-items-center justify-content-center"><span class="fs-16 d-flex align-items-center justify-content-center"><i class="isax isax-edit-2"></i></span></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="pb-3 border-bottom">
                            <div class="mb-3 review-img">
                                <img src="{{URL::asset('build/img/cars/car-large-01.jpg')}}" alt="Img" class="img-fluid">
                            </div>
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h6 class="mb-2">Audi A3 2019</h6>
                        ...
                        <div class="mt-3 pb-3 border-bottom">
                            ...
                            <div class="d-flex align-items-center details-info">
                                <h6 class="fs-16">Return</h6>
                                <p class="fs-16">25 May 2025, 06:00 PM</p>
                            </div>
                            <div class="d-flex align-items-center  details-info">
                                <h6 class="fs-16">Passengers</h6>
                                <p class="fs-16">2</p>
                            </div>
                            <div class="d-flex align-items-center details-info">
                                <h6 class="fs-16">Car Type</h6>
                                <p class="fs-16">Sedan</p>
                            </div>
                            <div class="d-flex align-items-center details-info">
                                <h6 class="fs-16">Extra Services</h6>
                                <p class="fs-16">Wi-Fi Hotspot, GPS Navigation</p>
                            </div>
                        </div>
                        <div class="mt-3 border-bottom">
                            <h6 class="text-primary mb-3">Payment Info</h6>
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <h6 class="fs-16">Sub Total</h6>agent-hotel
                                <p class="fs-16">$1100</p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-3">
