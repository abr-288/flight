                    ...
                    <div class="accordion-item border-0 mb-4">
                        ...
                        <div id="accordion_collapse_two" class="accordion-collapse collapse show">
                            <div class="accordion-body pt-0">
                                <p class="mb-2">Kicking off on April 1, 2025, the "DreamsTour" will take Luna to major cities across North America and Europe, including Los Angeles, New York, Chicago, Toronto, and London.
                                ...
                                <div class="hotel-list">
                                        ...
                                        <div class="place-content pb-1">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                <div class="overflow-hidden">
                                                    <h5 class="mb-2 d-inline-flex align-items-center text-truncate"><a href="{{url('flight-details')}}">Economy Class</a></h5>
                                                </div>
                                            ...
                                            <div class="d-flex align-items-center flex-wrap">
                                                <p class="me-3 mb-3 d-inline-flex align-items-center"><i class="isax isax-tick-circle5 text-success me-1"></i>Excess Baggage</p>
                                                <p class="mb-3 d-inline-flex align-items-center"><i class="isax isax-tick-circle5 text-success me-1"></i>Priority Boarding</p>
                                            </div>
                                            <div class="d-flex align-items-center flex-wrap">
                                                <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-3"> LED TV 2</span>
                                                <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-3">15 m²</span>
                                                <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-3">Free WiFi</span>
                                                <span class="badge badge-info-100 fs-10 fw-medium rounded-pill me-2 mb-3">Private Safe</span>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                                <h5 class="text-primary me-2">$500 <span class="text-default text-decoration-line-through">$252</span> <span class="fs-14 fw-normal text-default">/ Person ( $759 total includes taxes & fees )</span></h5>
                                    ...
                                    <div class="place-item mb-4">
                                        ...
                                        <div class="place-content pb-1">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                <div class="overflow-hidden">
                                                    <h5 class="mb-2 d-inline-flex align-items-center text-truncate"><a href="{{url('flight-details')}}">Business Class</a></h5>
                                                </div>
                                                <div class="d-flex align-items-center text-nowrap mb-2">
                                                    <span class="badge badge-warning badge-xs text-gray-9 fs-13 fw-medium me-2">4.3</span>
                                                    <p class="fs-14">(380 Reviews)</p>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3">
                                                <h5 class="text-primary me-2">$500 <span class="text-default text-decoration-line-through">$658</span> <span class="fs-14 fw-normal text-default">/ Person ( $756 total includes taxes & fees )</span></h5>
                                                <div class="btn btn-primary btn-md">
                                                    <div class="form-check d-flex align-items-center ps-0">
                                    ...
                                    <div class="place-item mb-4">
                                        <div class="place-img">
                                            <div class="img-slider owl-carousel nav-center">
                                                <div class="slide-images">
                                                    <a href="{{url('flight-details')}}">
                                                        <img src="{{URL::asset('build/img/flight/flight-13.jpg')}}" class="img-fluid" alt="img">
                                                    </a>
                                                </div>
                                                <div class="slide-images">
                                                    <a href="{{url('flight-details')}}">
                                                        <img src="{{URL::asset('build/img/flight/flight-12.jpg')}}" class="img-fluid" alt="img">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="fav-item justify-content-end">
                                        ...
                                        <div class="place-content pb-1">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                <div class="overflow-hidden">
                                                    <h5 class="mb-2 d-inline-flex align-items-center text-truncate"><a href="{{url('flight-details')}}">Regular</a></h5>
                                                </div>
                                                <div class="d-flex align-items-center text-nowrap mb-2">
                                                    <span class="badge badge-warning badge-xs text-gray-9 fs-13 fw-medium me-2">4.3</span>
                                                    <p class="fs-14">(380 Reviews)</p>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between flex-wrap border-top pt-3 gap-2">
                                                <h5 class="text-primary me-2">$500 <span class="text-default text-decoration-line-through">$989</span> <span class="fs-14 fw-normal text-default">/ Person ( $1059 total includes taxes & fees )</span></h5>
                                                <div class="btn btn-primary btn-md">
                                                    <div class="form-check d-flex align-items-center ps-0">
                                                        <input class="form-check-input ms-0 mt-0 border border-white" name="book" type="checkbox" id="book3" checked>
                ...
                <div class="card shadow-none">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-4">
                            <span class="btn btn-outline-light flex-fill"><span class="icon-rotate-up me-2"><i class="isax isax-airplane"></i></span>Newyork</span>
                            <a href="javascript:void(0);" class="way-icon badge badge-primary rounded-pill mx-2">
                                <i class="fa-solid fa-arrow-right-arrow-left"></i>
                            </a>
                            <span class="btn btn-outline-light flex-fill"><span class="icon-rotate-down me-2"><i class="isax isax-airplane"></i></span>Sydney</span>
                        </div>
