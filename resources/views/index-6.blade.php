            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="banner-content wow fadeInUp mb-4" data-wow-delay="0.3">
                        <h1 class="text-white display-5 mb-2">Booking a tour can be an exciting way to <br> explore a new destination!</h1>
                    ...
                    <div class="banner-form-tab-six">
                        <ul class="nav">
                            ...
                            <li>
                                <a href="javascript:void(0);" class="nav-link active" data-bs-toggle="tab" data-bs-target="#Tour">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 wow fadeInUp" data-wow-delay="0.2s">
                <div class="section-header-six">
                    <span class="badge badge-soft-primary rounded-pill mb-1">Featured Categories</span>
                    <h2>Travelers & Preferences<span class="text-primary">.</span></h2>
                </div>
            </div>
            <div class="col-md-4">
                <div class="text-end">
                    <a href="{{ url('tour-grid')}}" class="btn btn-dark sec-head-btn">View All Categories<i class="isax isax-arrow-right-3 ms-2"></i></a>
                </div>
            </div>
        </div>
        <div class="categories-slider-six owl-carousel">
            <div class="categories-card wow fadeInUp" data-wow-delay="0.5">
                <a href="{{ url('tour-grid')}}"><img src="{{URL::asset('build/img/tours/tours-30.jpg')}}" alt="Img"></a>
                <div class="cat-content d-flex align-items-center justify-content-between">
                    <div>
                        <h5 class="text-white mb-1">Ecotourism</h5>
                        <span class="text-white">25 Tours</span>
                    </div>
                    <a href="{{ url('tour-grid')}}" class="loc-view-bottom"><i class="isax isax-arrow-right-1"></i></a>
                </div>
            </div>
            <div class="categories-card wow fadeInUp" data-wow-delay="1.0">
                <a href="{{ url('tour-grid')}}"><img src="{{URL::asset('build/img/tours/tours-31.jpg')}}" alt="Img"></a>
                <div class="cat-content d-flex align-items-center justify-content-between">
                    <div>
                        <h5 class="text-white mb-1">Adventure Tour</h5>
                        <span class="text-white">47 Tours</span>
                    </div>
                    <a href="{{ url('tour-grid')}}" class="loc-view-bottom"><i class="isax isax-arrow-right-1"></i></a>
                </div>
            </div>
            <div class="categories-card wow fadeInUp" data-wow-delay="1.5">
                <a href="{{ url('tour-grid')}}"><img src="{{URL::asset('build/img/tours/tours-32.jpg')}}" alt="Img"></a>
                <div class="cat-content d-flex align-items-center justify-content-between">
                    <div>
                        <h5 class="text-white mb-1">Group Tours</h5>
                        <span class="text-white">38 Tours</span>
                    </div>
                    <a href="{{ url('tour-grid')}}" class="loc-view-bottom"><i class="isax isax-arrow-right-1"></i></a>
                </div>
            </div>
            <div class="categories-card wow fadeInUp" data-wow-delay="2.0">
                <a href="{{ url('tour-grid')}}"><img src="{{URL::asset('build/img/tours/tours-33.jpg')}}" alt="Img"></a>
                <div class="cat-content d-flex align-items-center justify-content-between">
                    <div>
                        <h5 class="text-white mb-1">Beach Tours</h5>
                        <span class="text-white">54 Tours</span>
                    </div>
                    <a href="{{ url('tour-grid')}}" class="loc-view-bottom"><i class="isax isax-arrow-right-1"></i></a>
                </div>
            </div>
            <div class="categories-card wow fadeInUp" data-wow-delay="2.5">
                <a href="{{ url('tour-grid')}}"><img src="{{URL::asset('build/img/tours/tours-34.jpg')}}" alt="Img"></a>
                <div class="cat-content d-flex align-items-center justify-content-between">
                    <div>
                        <h5 class="text-white mb-1">Honey Moon</h5>
                        <span class="text-white">22 Tours</span>
                    </div>
                    <a href="{{ url('tour-grid')}}" class="loc-view-bottom"><i class="isax isax-arrow-right-1"></i></a>
                </div>
            </div>
            <div class="categories-card wow fadeInUp" data-wow-delay="3.0">
                <a href="{{ url('tour-grid')}}"><img src="{{URL::asset('build/img/tours/tours-30.jpg')}}" alt="Img"></a>
                <div class="cat-content d-flex align-items-center justify-content-between">
                    <div>
                        <h5 class="text-white mb-1">Ecotourism</h5>
            ...
            <div class="categories-card wow fadeInUp" data-wow-delay="3.5">
                <a href="{{ url('tour-grid')}}"><img src="{{URL::asset('build/img/tours/tours-31.jpg')}}" alt="Img"></a>
                <div class="cat-content d-flex align-items-center justify-content-between">
                    <div>
                        <h5 class="text-white mb-1">Adventure Tour</h5>
                            ...
                            <div class="card border-0 mb-0">
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-truncate line-clamb-3">Ensure that the tour is available on the dates you plan to travel. Browse available tours in your destination.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card border-0 mb-0">
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-truncate line-clamb-3">Make sure to be at the meeting point on time, Ask questions and enjoy the experience!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 wow fadeInUp" data-wow-delay="0.2s">
                <div class="section-header-six">
                    ...
                    <h2>Popular Tours Around the World<span class="text-primary">.</span></h2>
                </div>
            </div>
            <div class="col-md-4">
                <div class="text-end">
        ...
        <div class="cars-slider owl-dot-bottom owl-carousel wow fadeInUp" data-wow-delay="1.5">
            ...
            <div class="place-item mb-4 flex-fill">
                ...
                <div class="place-content">
                    ...
                    <div class="mb-3">
                        <h6 class="d-flex align-items-center text-gray-6 fs-14 fw-normal">Starts From <span class="ms-1 fs-18 fw-semibold text-primary">$450</span><span class="ms-1 fs-18 fw-semibold text-gray-3 text-decoration-line-through">$520</span></h6>
                    </div>
                    <div class="d-flex align-items-center justify-content-between border-top pt-3">
                        <div class="d-flex flex-wrap align-items-center me-2">
                            <span class="me-1"><i class="isax isax-calendar-tick text-gray-6"></i></span>
            ...
            <div class="place-item mb-4 flex-fill">
                ...
                <div class="place-content">
                    ...
                    <div class="mb-3">
                        <h6 class="d-flex align-items-center text-gray-6 fs-14 fw-normal">Starts From <span class="ms-1 fs-18 fw-semibold text-primary">$350</span><span class="ms-1 fs-18 fw-semibold text-gray-3 text-decoration-line-through">$400</span></h6>
                    </div>
                    <div class="d-flex align-items-center justify-content-between border-top pt-3">
                        <div class="d-flex flex-wrap align-items-center me-2">
                            <span class="me-1"><i class="isax isax-calendar-tick text-gray-6"></i></span>
            ...
            <div class="col-lg-5">
                <div>
                    <div class="section-right-img-two wow fadeInUp" data-wow-delay="1.5">
                        <img src="{{URL::asset('build/img/section-img-02.png')}}" alt="Img">
            ...
            <div class="col-lg-7">
                <div>
                    <div class="section-header-six mb-4 wow fadeInUp" data-wow-delay="1.5">
                        ...
                        <h2 class="mb-2">Provide high-quality Accommodations & service make journeys seamless & enjoyable.</h2>
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <a href="{{ url('about-us')}}" class="btn btn-dark me-3">Get Started<i class="isax isax-arrow-right-3 ms-2"></i></a>
                        <a data-fancybox="" href="https://youtu.be/NSAOrGb9orM" class="btn btn-white"><i class="isax isax-play-circle5 me-2"></i>Watch Video</a>
                    </div>
                    <div class="row g-4">
                        <div class="col-md-4 d-flex">
                            <div class="counter-item card shadow-none flex-fill mb-0">
                                <div class="card-body">
                                    <h3 class="display-6 text-primary mb-2"><span class="counter text-dark">57</span>+</h3>
                        ...
                        <div class="col-md-4 d-flex">
                            <div class="counter-item card shadow-none flex-fill mb-0">
                                <div class="card-body">
                                    <h3 class="display-6 text-primary mb-2"><span class="counter text-dark">7098</span>+</h3>
                        ...
                        <div class="col-md-4 d-flex">
                            <div class="counter-item card shadow-none flex-fill mb-0">
                                <div class="card-body">
                                    <h3 class="display-6 text-primary mb-2"><span class="counter text-dark">67</span>+</h3>
                                    <p>Client Globally</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 wow fadeInUp" data-wow-delay="0.2s">
                <div class="section-header-six">
                    ...
                    <h2>Try Relaxing Accomodations<span class="text-primary">.</span></h2>
                </div>
            </div>
            <div class="col-md-4">
                <div class="text-end">
                    <a href="{{ url('team')}}" class="btn btn-dark sec-head-btn">View All Providers<i class="isax isax-arrow-right-3 ms-2"></i></a>
                </div>
            </div>
        </div>
        <div class="providers-slider owl-carousel owl-dot-bottom">
            <div class="card">
                <div class="card-body text-center">
                    <a href="{{ url('tour-details')}}" class="d-block mb-3"><img src="{{URL::asset('build/img/icons/hotel-logo-02.svg')}}" class="rounded-circle w-auto m-auto" alt="Img"></a>
                    <h5 class="mb-2"><a href="{{ url('tour-details')}}">Mystery Manor</a></h5>
                    <div class="d-flex align-items-center seperate-dot justify-content-center">
                        <span>Eco Tours</span>
                        <span>Ukraine</span>
                    </div>
            ...
            <div class="card">
                <div class="card-body text-center">
                    <a href="{{ url('tour-details')}}" class="d-block mb-3"><img src="{{URL::asset('build/img/icons/hotel-logo-01.svg')}}" class="rounded-circle w-auto m-auto" alt="Img"></a>
                    <h5 class="mb-2"><a href="{{ url('tour-details')}}">Adventure Suites</a></h5>
                    <div class="d-flex align-items-center seperate-dot justify-content-center">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-3 pt-3 border-top">
                        ...
                        <span class="badge bg-teal">145 Tours</span>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-body text-center">
                    <a href="{{ url('tour-details')}}" class="d-block mb-3"><img src="{{URL::asset('build/img/icons/hotel-logo-03.svg')}}" class="rounded-circle w-auto m-auto" alt="Img"></a>
                    <h5 class="mb-2"><a href="{{ url('tour-details')}}">Harmony Retreat</a></h5>
                    <div class="d-flex align-items-center seperate-dot justify-content-center">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-3 pt-3 border-top">
                        ...
                        <span class="badge bg-teal">221 Tours</span>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-body text-center">
                    <a href="{{ url('tour-details')}}" class="d-block mb-3"><img src="{{URL::asset('build/img/icons/hotel-logo-04.svg')}}" class="rounded-circle w-auto m-auto" alt="Img"></a>
                    <h5 class="mb-2"><a href="{{ url('tour-details')}}">Tranquil Spa</a></h5>
                    <div class="d-flex align-items-center seperate-dot justify-content-center">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-3 pt-3 border-top">
                        ...
                        <span class="badge bg-teal">178 Tours</span>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-body text-center">
                    <a href="{{ url('tour-details')}}" class="d-block mb-3"><img src="{{URL::asset('build/img/icons/providers-logo.svg')}}" class="rounded-circle w-auto m-auto" alt="Img"></a>
                    <h5 class="mb-2"><a href="{{ url('tour-details')}}">Mystery Manor</a></h5>
                    <div class="d-flex align-items-center seperate-dot justify-content-center">
                        <span>Adventure Tours</span>
                        <span>Brazil</span>
...
<section class="section testi-sec-six pb-0">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div>
                    <img src="{{URL::asset('build/img/section-img-03.png')}}" alt="Img">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="testi-info-six">
                    ...
                    <div>
                        ...
                        <p class="mb-4 testi-para">I had an I recently booked a flight through, and I couldn’t be happier with the experience.After finally selecting a flight, I was hit with unexpected fees during checkout that weren’t clearly stated upfront.
                        </p>
            ...
            <div class="col-lg-6">
                <div class="tourism-text-info">
                    <div class="text-header">
                        <h2>Trusted Solution Of Your <span class="text-primary"> <img src="{{URL::asset('build/img/tours/tour-img.jpg')}}" alt="Img"> Tourism</span> Services</h2>
                    </div>
...
<section class="section blog-section blog-sec-six">
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-4">
                <div class="text-end">
                    <a href="{{ url('blog-grid')}}" class="btn btn-dark sec-head-btn">View All Blogs<i class="isax isax-arrow-right-3 ms-2"></i></a>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="card shadow-none blog-grid-six">
                    <div class="card-img">
                        <a href="{{ url('blog-details')}}">
                            <img src="{{URL::asset('build/img/blog/blog-30.jpg')}}" class="rounded" alt="Img">
                        </a>
                        <span class="badge bg-primary">Booking</span>
                    </div>
                    <div class="card-body">
                        <h5 class="mb-2"><a href="{{ url('blog-details')}}">It empowers designers to swiftly created</a></h5>
                        <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt u</p>
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <span class="d-inline-flex align-items-center"><i class="isax isax-calendar me-2 fs-20"></i>27 Sep 2025</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6 d-flex">
                            <div class="card-img flex-fill">
                                <a href="{{ url('blog-details')}}">
                                    <img src="{{URL::asset('build/img/blog/blog-31.jpg')}}" class="rounded w-100 h-100" alt="Img">
                                </a>
                                <span class="badge bg-primary">Booking</span>
                            </div>
                        </div>
                        <div class="col-md-6 d-flex">
                            <div class="card-body ps-md-0 flex-fill">
                                <h5 class="mb-2"><a href="{{ url('blog-details')}}">It empowers designers to swiftly created</a></h5>
                                <p class="mb-4 text-truncate line-clamb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt u</p>
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2">
                                            <img src="{{URL::asset('build/img/users/user-01.jpg')}}" class="rounded-circle" alt="img">
                ...
                <div class="card shadow-none blog-grid-six">
                    <div class="row align-items-center">
                        <div class="col-md-6 d-flex">
                            <div class="card-img flex-fill">
                                <a href="{{ url('blog-details')}}">
                                    <img src="{{URL::asset('build/img/blog/blog-32.jpg')}}" class="rounded w-100 h-100" alt="Img">
                                </a>
                                <span class="badge bg-primary">Booking</span>
                            </div>
                        </div>
