                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{url('agent-tour-booking')}}" class="fs-14 d-inline-flex align-items-center active">Tour</a>
                                    </li>
                                    <li>
            ...
            <div class="col-xl-9 col-lg-8 theiaStickySidebar">
                ...
                <div class="card booking-header border-0">
                    <div class="card-body header-content d-flex align-items-center justify-content-between flex-wrap ">
                        <div>
                            <h6 class="mb-1">Tour Bookings</h6>
                        ...
                        <div class="custom-datatable-filter table-responsive">
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="javascript:void(0);" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#completed">#TR-6545</a></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
