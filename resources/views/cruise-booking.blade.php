                ...
                <div class="card order-details">
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between header-content">
                            ...
                            <a href="{{url('cruise-details')}}" class="rounded-circle p-2 btn btn-light d-flex align-items-center justify-content-center"><span class="fs-16 d-flex align-items-center justify-content-center"><i class="isax isax-edit-2"></i></span></a>
                        </div>
                    </div>
                    <div class="card-body">                            
                        <div class="pb-3 border-bottom">
                            <div class="mb-3 review-img">
                                <img src="{{URL::asset('build/img/cruise/cruise-large-03.jpg')}}" alt="Img" class="img-fluid">
                            </div>
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h6 class="mb-2">Coral Cruiser - Balcony</h6>
                                    <p class="fs-14 "><span class="badge badge-warning text-gray-9 fs-13 fw-medium me-2">5.0</span>(400 Reviews)</p>
                                </div>
                                <h6 class="fs-14 fw-normal text-gray-9">$2000</h6>
                            </div>
                        </div>
                        <div class="mt-3 pb-3 border-bottom">
                            ...
                            <div class="d-flex align-items-center details-info">
                                ...
                                <p class="fs-16">21 Sep 2025 at 09:15 AM</p>
                            </div>
                            <div class="d-flex align-items-center  details-info">
                            ...
                            <div class="d-flex align-items-center details-info">
                                <h6 class="fs-16">No of Days</h6>
                                <p class="fs-16">5 Days, 4 Night</p>
                            </div>
                        </div>
