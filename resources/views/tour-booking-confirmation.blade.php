<?php $page="tour-booking-confirmation";?>
						...
						<div class="card-body">
							<div class="bg-light-200 border border-light p-3 rounded-2 mb-4">
								<div class="d-flex flex-wrap align-items-center justify-content-between ">
									<div class="d-flex flex-wrap align-items-center booking-hotels">
										<a href="{{url('tour-details')}}" class="avatar avatar-lg me-2">
											<img src="{{URL::asset('build/img/tours/tours-21.jpg')}}" alt="image" class="img-fluid  rounded-circle">
										</a>
										<div class="booking-details">
											<h6 class="mb-1"><a href="{{url('tour-details')}}">LaughFest Carnival</a></h6>
											<div class="d-flex flex-wrap align-items-center booking-items">
												<p class="fs-14 text-gray-6 pe-2 border-end border-light d-flex align-items-center me-2 ">
													<i class="isax isax-signpost5 me-2"></i>Sightseeing Tours
												</p>
												<p class="fs-14 text-gray-6 pe-2 border-end border-light d-flex align-items-center me-2 ">
							...
							<div class="pb-4 border-bottom mb-4">
								...
								<div class="d-flex flex-wrap align-items-center service-info gap-3">
									<span class="badge badge-light rounded-pill">Local Expert Guides</span>
									<span class="badge badge-light rounded-pill">Photography Services</span>
								</div>
							</div>
							<div class="pb-4 border-bottom mb-4">
