            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                <div>
                    <div class="d-flex align-items-center mb-2">
                        <h4 class="d-flex align-items-center flex-wrap fw-bold">Audi A3 2019</h4>
                        <div class="d-flex align-items-center ms-2">
                            <span class="badge badge-warning badge-xs text-gray-9 fs-13 fw-medium me-2">4.5</span>
                            <p class="fs-14"><a href="#field_nine">(500 Reviews)</a></p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center flex-wrap row-gap-2">
                        <p class="fs-14 mb-0 me-3 pe-3 border-end d-inline-flex align-items-center"><span><i class="isax isax-smart-car text-primary me-2"></i></span>Sedan</p>
                        <p class="fs-14 mb-0 me-3 pe-3 border-end"><i class="isax isax-location5 me-2"></i>Ciutat Vella, Barcelona
                            <a href="#field_seven" class="link-primary text-decoration-underline fw-medium ms-2">View Location</a>
                        </p>
                        <div class="d-flex align-items-center flex-wrap row-gap-2">
                            <p class="fs-14 me-3 mb-0 d-inline-flex align-items-center"><span><i class="isax isax-tick-circle5 text-success me-1"></i></span>Dropoff</p>
                            <p class="fs-14 me-3 mb-0 d-inline-flex align-items-center"><span><i class="isax isax-tick-circle5 text-success me-1"></i></span>Airport Pickup</p>
                            <p class="fs-14 mb-0 d-inline-flex align-items-center"><span><i class="isax isax-tick-circle5 text-success me-1"></i></span>Hourly Package</p>
                        </div>
                    </div>
                </div>
                <div class="d-flex align-items-center flex-wrap row-gap-2">
                    ...
                    <a href="javascript:void(0);" class="btn btn-outline-light btn-sm d-inline-flex align-items-center me-2"><i class="isax isax-heart5 text-danger me-1"></i>Save</a>
                    <span class="badge badge-light text-gray-9 badge-md fs-13 fw-medium rounded-pill me-4">No of Bookings : 96</span>
                    <div>
                        <p class="fs-13 fw-medium mb-1">Starts From</p>
                        <h5 class="text-primary">$500 <span class="fs-14 text-default fw-normal">/ Night</span></h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-8">
                    ...
                    <!-- Slider -->
                    <div>
                        <div class="service-wrap card border-0 mb-4">
                            <div class="card-body">
                                <div class="slider-wrap vertical-slider vertical-slider-two d-flex align-items-center">
                                    <div class="slider-nav nav-center" id="small-img">
                                        <div><img src="{{URL::asset('build/img/cars/car-thumb-01.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                                        <div><img src="{{URL::asset('build/img/cars/car-thumb-02.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                                        <div><img src="{{URL::asset('build/img/cars/car-thumb-03.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                                        <div><img src="{{URL::asset('build/img/cars/car-thumb-04.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                                        <div><img src="{{URL::asset('build/img/cars/car-thumb-05.jpg')}}" class="img-fluid" alt="Slider Img"></div>
                                    </div>
                                    <div class="slider-for nav-center" id="large-img">
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cars/car-large-01.jpg')}}" class="img-fluid" alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cars/car-large-02.jpg')}}" class="img-fluid" alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cars/car-large-03.jpg')}}" class="img-fluid" alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cars/car-large-04.jpg')}}" class="img-fluid" alt="Slider Img">
                                        </div>
                                        <div class="service-img">
                                            <img src="{{URL::asset('build/img/cars/car-large-05.jpg')}}" class="img-fluid" alt="Slider Img">
                                        </div>
                                    </div>
                                    <a href="{{URL::asset('build/img/cars/car-large-01.jpg')}}" data-fancybox="gallery" class="btn btn-white btn-xs view-btn"><i class="isax isax-image me-1"></i>See All</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- /Slider -->
                    <ul class="active-tab-list d-flex align-items-center flex-wrap mb-4">
                        <li><a href="#field_one" class="btn active">Description</a></li>
                        <li><a href="#field_two" class="btn">Specification</a></li>
                        <li><a href="#field_three" class="btn">Services</a></li>
                        <li><a href="#field_four" class="btn">Gallery</a></li>
                        <li><a href="#field_five" class="btn">Video</a></li>
                        <li><a href="#field_six" class="btn">Features</a></li>
                        <li><a href="#field_seven" class="btn">Location</a></li>
                        <li><a href="#field_eight" class="btn">FAQ</a></li>
                        <li><a href="#field_nine" class="btn">Reviews</a></li>
                    </ul>
                    <div class="accordion custom-accordion">
                        <div class="accordion-item mb-4" id="field_three">
                                ...
                                <div class="accordion-body">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-md bg-primary-transparent rounded-circle me-2">
													<i class="isax isax-wifi fs-16"></i>
												</span>
                                                <p>Wi-Fi Hotspot</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-md bg-primary-transparent rounded-circle me-2">
													<i class="isax isax-check fs-16"></i>
												</span>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-md bg-primary-transparent rounded-circle me-2">
													<i class="isax isax-security-user fs-16"></i>
												</span>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-md bg-primary-transparent rounded-circle me-2">
													<i class="isax isax-gas-station fs-16"></i>
												</span>
                                                <p>Fuel Options</p>
                                            </div>
                                        </div>
                        ...
                        <div class="accordion-item mb-4" id="field_one">
                            ...
                            <div id="accordion_collapse_two" class="accordion-collapse collapse show">
                                <div class="accordion-body">
                                    <p class="mb-2">Kicking off on April 1, 2025, the "DreamsTour" will take Luna to major cities across North America and Europe, including Los Angeles, New York, Chicago, Toronto, and London. Each concert will showcase her unique blend
                                ...
                                <div class="accordion-body">
                                    <div class="row gy-3">
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-md bg-primary-transparent rounded-circle me-2">
													<i class="isax isax-data fs-16"></i>
												</span>
                                                <div>
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-md bg-primary-transparent rounded-circle me-2">
													<i class="isax isax-driving fs-16"></i>
												</span>
                                                <div>
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-md bg-primary-transparent rounded-circle me-2">
													<i class="isax isax-story fs-16"></i>
												</span>
                                                <div>
                                                    <h6 class="mb-1">Steering</h6>
                                                    <span>Auto</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-md bg-primary-transparent rounded-circle me-2">
													<i class="isax isax-calendar fs-16"></i>
												</span>
                                                <div>
                                                    <h6 class="mb-1">Model Year</h6>
                                                    <span>2019</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-md bg-primary-transparent rounded-circle me-2">
													<i class="isax isax-wind fs-16"></i>
												</span>
                                                <div>
                                                    <h6 class="mb-1">AC</h6>
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-md bg-primary-transparent rounded-circle me-2">
													<i class="isax isax-sun fs-16"></i>
												</span>
                                                <div>
                                                    <h6 class="mb-1">Engine (Hp)</h6>
                                                    <span>3,000</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-md bg-primary-transparent rounded-circle me-2">
													<i class="isax isax-drop3 fs-16"></i>
												</span>
                                                <div>
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-md bg-primary-transparent rounded-circle me-2">
													<i class="isax isax-screenmirroring fs-16"></i>
												</span>
                                                <div>
                                                    <h6 class="mb-1">Doors</h6>
                                                    <span>4</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-md bg-primary-transparent rounded-circle me-2">
													<i class="isax isax-flash fs-16"></i>
												</span>
                                                <div>
                                                    <h6 class="mb-1">Access</h6>
                                                    <span>Remote</span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div id="accordion_collapse_four" class="accordion-collapse collapse show">
                                <div class="accordion-body">
                                    <div class="tour-gallery-slider owl-carousel">
                                        <a class="galley-wrap" data-fancybox="gallery" href="{{URL::asset('build/img/cars/gallery-car-lg-01.jpg')}}">
                                            <img src="{{URL::asset('build/img/cars/gallery-car-01.jpg')}}" class="h-auto" alt="img">
                                        </a>
                                        <a class="galley-wrap" data-fancybox="gallery" href="{{URL::asset('build/img/cars/gallery-car-lg-02.jpg')}}">
                                            <img src="{{URL::asset('build/img/cars/gallery-car-02.jpg')}}" class="h-auto" alt="img">
                                        </a>
                                        <a class="galley-wrap" data-fancybox="gallery" href="{{URL::asset('build/img/cars/gallery-car-lg-03.jpg')}}">
                                            <img src="{{URL::asset('build/img/cars/gallery-car-03.jpg')}}" class="h-auto" alt="img">
                                        </a>
                                        <a class="galley-wrap" data-fancybox="gallery" href="{{URL::asset('build/img/cars/gallery-car-lg-04.jpg')}}">
                                            <img src="{{URL::asset('build/img/cars/gallery-car-04.jpg')}}" class="h-auto" alt="img">
                                        </a>
                                        <a class="galley-wrap" data-fancybox="gallery" href="{{URL::asset('build/img/cars/gallery-car-lg-05.jpg')}}">
                                            <img src="{{URL::asset('build/img/cars/gallery-car-05.jpg')}}" class="h-auto" alt="img">
                                        </a>
                                        <a class="galley-wrap" data-fancybox="gallery" href="{{URL::asset('build/img/cars/gallery-car-lg-06.jpg')}}">
                                            <img src="{{URL::asset('build/img/cars/gallery-car-06.jpg')}}" class="h-auto" alt="img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="accordion-body">
                                    <div class="position-relative">
                                        <a href="javascript:void(0);">
                                            <img src="{{URL::asset('build/img/cars/car-large-01.jpg')}}" class="rounded" alt="Img">
                                        </a>
                                        <a href="https://www.youtube.com/watch?v=4fMuE_t5YL4" data-fancybox="" class="avatar avatar-lg rounded-circle bg-white circle-middle">
                                        ...
                                        <div class="card review-item shadow-none mb-3">
                                            <div class="card-body p-3">
                                                <div class="review-info">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <a class="avatar avatar-md me-2 mb-2" data-fancybox="gallery" href="{{URL::asset('build/img/cars/gallery-car-lg-01.jpg')}}">
                                                            <img src="{{URL::asset('build/img/cars/gallery-car-01.jpg')}}" class="h-auto" alt="img">
                                                        </a>
                                                        <a class="avatar avatar-md me-2 mb-2" data-fancybox="gallery" href="{{URL::asset('build/img/cars/gallery-car-lg-02.jpg')}}">
                                                            <img src="{{URL::asset('build/img/cars/gallery-car-02.jpg')}}" class="h-auto" alt="img">
                                                        </a>
                                                        <a class="avatar avatar-md me-0 mb-2" data-fancybox="gallery" href="{{URL::asset('build/img/cars/gallery-car-lg-03.jpg')}}">
                                                            <img src="{{URL::asset('build/img/cars/gallery-car-03.jpg')}}" class="h-auto" alt="img">
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="card review-item shadow-none mb-3">
                                            <div class="card-body p-3">
                                                <div class="review-info">
                                                    ...
                                                    <div class="d-inline-flex align-items-center">
                                                        <a href="javascript:void(0);" class="d-inline-flex align-items-center fs-14 me-3"><i class="isax isax-like-1 me-2"></i>15</a>
                                                        <a href="javascript:void(0);" class="d-inline-flex align-items-center me-3"><i class="isax isax-dislike me-2"></i>30</a>
                                                        <a href="javascript:void(0);" class="d-inline-flex align-items-center me-3"><i class="isax isax-heart5 text-danger me-2"></i>52</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card review-item shadow-none mb-3">
                                            <div class="card-body p-3">
                                                <div class="review-info">
                                                    ...
                                                    <div class="d-inline-flex align-items-center">
                                                        <a href="javascript:void(0);" class="d-inline-flex align-items-center fs-14 me-3"><i class="isax isax-like-1 me-2"></i>13</a>
                                                        <a href="javascript:void(0);" class="d-inline-flex align-items-center me-3"><i class="isax isax-dislike me-2"></i>38</a>
                                                        <a href="javascript:void(0);" class="d-inline-flex align-items-center me-3"><i class="isax isax-heart5 text-danger me-2"></i>75</a>
                                                    </div>
                                                </div>
                                                <div class="review-info reply mt-4 p-3">
                                                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                        ...
                                                        <a href="javascript:void(0);" class="btn btn-outline-light btn-md d-inline-flex align-items-center me-2"><i class="isax isax-repeat me-1"></i>Reply</a>
                                                    </div>
                                                    ...
                                                    <div class="d-inline-flex align-items-center">
                                                        <a href="javascript:void(0);" class="d-inline-flex align-items-center fs-14 me-3"><i class="isax isax-like-1 me-2"></i>10</a>
                                                        <a href="javascript:void(0);" class="d-inline-flex align-items-center me-3"><i class="isax isax-dislike me-2"></i>21</a>
                                                        <a href="javascript:void(0);" class="d-inline-flex align-items-center me-3"><i class="isax isax-heart5 text-danger me-2"></i>46</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="text-center mb-4 mb-xl-0">
                                            <a href="javascript:void(0);" class="btn btn-primary btn-md d-inline-flex align-items-center justify-content-center mt-2">See all 4,078 reviews<i class="isax isax-arrow-right-3 ms-1"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item mb-4 mb-xl-0">
                            <div class="accordion-header">
                                                    ...
                                                    <div class="selection-wrap">
                                                        <div class="d-inline-block">
                                                            <div class="rating-selction">
                                                                <input type="radio" name="rating" value="5" id="rating05">
                                                                <label for="rating05"><i class="fa-solid fa-star"></i></label>
                                                                <input type="radio" name="rating" value="4" id="rating04">
                                                                <label for="rating04"><i class="fa-solid fa-star"></i></label>
                                                                <input type="radio" name="rating" value="3" id="rating03">
                                                                <label for="rating03"><i class="fa-solid fa-star"></i></label>
                                                                <input type="radio" name="rating" value="2" id="rating02">
                                                                <label for="rating02"><i class="fa-solid fa-star"></i></label>
                                                                <input type="radio" name="rating" value="1" id="rating01">
                                                                <label for="rating01"><i class="fa-solid fa-star"></i></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="col-xl-4 theiaStickySidebar">
                    <div class="card shadow-none">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center flex-wrap mb-2">
                                <div class="form-check me-3 d-flex mb-2">
                                    <input class="form-check-input me-2" type="radio" name="availability" id="available_1" checked="">
                                    <label class="form-check-label" for="available_1">
                                        Same drop-off
                                    </label>
                                </div>
                                <div class="form-check me-3 d-flex mb-2">
                                    <input class="form-check-input me-2" type="radio" name="availability" id="available_2">
                                    <label class="form-check-label" for="available_2">
                                        Different Drop off
                                    </label>
                                </div>
                                <div class="form-check me-3 d-flex mb-2">
                                    <input class="form-check-input me-2" type="radio" name="availability" id="available_3">
                                    <label class="form-check-label" for="available_3">
                                        Airport
                                    </label>
                                </div>
                                <div class="form-check me-3 d-flex mb-2">
                                    <input class="form-check-input me-2" type="radio" name="availability" id="available_4">
                                    <label class="form-check-label" for="available_4">
                                        Hourly Package
                                    </label>
                                </div>
                            </div>
                            <div class="banner-form">
                                <form action="{{ url('car-booking')}}" class="form-info border-0">
                                    <div class="d-flex align-items-center border rounded mb-3">
                                        <div class="flex-fill">
                                            <div class="form-item dropdown from-location p-3">
                                            ...
                                            <div class="form-item dropdown pickup-airport p-3">
                                                <div data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false" role="menu">
                                                    <label class="form-label fs-14 text-default mb-1">From</label>
                                                    <input type="text" class="form-control" value="Newyork">
                                        ...
                                        <div class="form-item dropdown to-location flex-fill ps-3 ps-sm-4 p-2">
                                            <div data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false" role="menu">
                                                <label class="form-label fs-14 text-default mb-1">To</label>
                                                <input type="text" class="form-control" value="Las Vegas">
                                                <p class="fs-12 mb-0">USA</p>
                                    ...
                                    <div class="form-info border-0">
                                        <div class="form-item border rounded p-3 mb-3 w-100">
                                            <label class="form-label fs-14 text-default mb-0">Departure</label>
                                            <input type="text" class="form-control datetimepicker" value="21-10-2025">
                                            <p class="fs-12">Monday</p>
                                        </div>
                                        <div class="form-item border rounded p-3 mb-3 w-100">
                                            <label class="form-label fs-14 text-default mb-0">Return</label>
                                            <input type="text" class="form-control datetimepicker" value="21-10-2025">
                                            <p class="fs-12">Wednesday</p>
                                        </div>
                                        <div class="form-item border rounded p-3 mb-3 w-100">
                                        ...
                                        <div class="card-body p-3 pb-0">
                                            ...
                                            <div class="custom-increment">
                                                <div class="mb-3 d-flex align-items-center justify-content-between">
                                                    <label class="form-label text-gray-9">Passengers</label>
                                                    <div class="custom-increment">
                                                        <div class="input-group">
                                    ...
                                    <h6 class="text-success fs-14 fw-medium mb-3">Available For Ride</h6>
                    ...
                    <div class="card shadow-none mb-0">
                        <div class="card-body">
                            ...
                            <div class="py-1">
                                <div class="bg-light-500 br-10 mb-3 d-flex align-items-center p-3">
                                    ...
                                    <div class="ms-2 overflow-hidden">
                                        <h6 class="fw-medium text-truncate"><a href="javascript:void(0);">Adrian Hendriques</a></h6>
                            ...
                            <div class="row g-2">
                                <div class="col-sm-6">
                                    <a href="javascript:void(0);" class="btn btn-light d-flex align-items-center justify-content-center"><i class="isax isax-messages5 me-2"></i>Whatsapp Us</a>                               
                                </div>
                                <div class="col-sm-6">
