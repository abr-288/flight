            ...
            <div class="row align-items-center">
                <div class="col-md-12 mx-auto">
                    ...
                    <div class="banner-content wow fadeInUp" data-wow-delay="0.3">
                        ...
                        <h6 class="text-white mx-auto">Explore stunning destinations and world-class experiences aboard our award-winning ships</h6>
                    </div>
                    <div class="banner-form card mb-0 wow fadeInUp" data-wow-delay="1.5">
                        <div class="card-header">
                            <ul class="nav">
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="nav-link active" data-bs-toggle="tab" data-bs-target="#Cruise">
...
<section class="section destination-section">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-10 text-center wow fadeInUp" data-wow-delay="0.2s">
                <div class="section-header text-center">
                    <h2 class="mb-2">Explore Our <span class="text-primary  text-decoration-underline">Cruise Types</span>  </h2>
                    <p class="sub-title">Find the perfect cruise experience tailored to your unique interests and travel style.</p>
                </div>
            </div>
        </div>
        <div class="owl-carousel cruise-slider nav-center wow fadeInUp">
            <div class="cruise-type">
                <img src="{{URL::asset('build/img/cruise/cruise-15.jpg')}}" alt="img">
                <h6><a href="{{ url('cruise-grid')}}">Luxury Cruise</a></h6>
            </div>
            <div class="cruise-type">
                <img src="{{URL::asset('build/img/cruise/cruise-18.jpg')}}" alt="img">
                <h6><a href="{{ url('cruise-grid')}}">Adventure Cruise</a></h6>
            </div>
            <div class="cruise-type">
                <img src="{{URL::asset('build/img/cruise/cruise-17.jpg')}}" alt="img">
                <h6><a href="{{ url('cruise-grid')}}">Expedition Cruise</a></h6>
            </div>
            <div class="cruise-type">
                <img src="{{URL::asset('build/img/cruise/cruise-19.jpg')}}" alt="img">
                <h6><a href="{{ url('cruise-grid')}}">Family Cruise</a></h6>
            </div>
            <div class="cruise-type">
                <img src="{{URL::asset('build/img/cruise/cruise-16.jpg')}}" alt="img">
                <h6><a href="{{ url('cruise-grid')}}">River Cruises</a></h6>
            </div>
            <div class="cruise-type">
                <img src="{{URL::asset('build/img/cruise/cruise-20.jpg')}}" alt="img">
                <h6><a href="{{ url('cruise-grid')}}">World Cruises</a></h6>
            </div>
            <div class="cruise-type">
                <img src="{{URL::asset('build/img/cruise/cruise-15.jpg')}}" alt="img">
                <h6><a href="{{ url('cruise-grid')}}">Luxury Cruise</a></h6>
        ...
        <div class="text-center view-all wow fadeInUp">
            <a href="{{ url('cruise-grid')}}" class="btn btn-primary">More Categories<i class="isax isax-arrow-right-3 ms-2"></i></a>
        </div>
    </div>
</section>
<!-- /type Section -->

<section class="support-section bg-dark support-section-five  wow fadeInUp">
    <div class="horizontal-slide d-flex" data-direction="left" data-speed="slow" data-animated="true">
        ...
        <div class="row align-items-center">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="years-off  wow fadeInUp">
                            <h4 class="text-light"> 15 Years of Experience</h4>
                        </div>
                        <div class="discover-set-img-left  wow fadeInDown ">
                            <img src="{{URL::asset('build/img/cruise/cruise-22.jpg')}}" alt="Img">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="discover-set-img-right wow zoomIn">
                            <img src="{{URL::asset('build/img/cruise/cruise-21.jpg')}}" alt="Img">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="section-header mb-4  wow fadeInUp">
                    ...
                    <p class="sub-title">At DreamsTour, we are passionate about turning your dream vacation into a reality. With years of experience in the cruise industry, we specialize in offering a wide range of cruise options tailored to meet your preferences, whether
                ...
                <div class="row">
                    <div class="col-lg-6  mb-3  wow fadeInUp">
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('build/img/icons/extensive.svg')}}" alt="Img">
                                    <div class="ms-2">
                                        <h6 class="fs-16 mb-2">Extensive Cruise Options</h6>
                    ...
                    <div class="col-lg-6  mb-3  wow fadeInUp">
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('build/img/icons/trust.svg')}}" alt="Img">
                                    <div class="ms-2">
                                        <h6 class="fs-16  mb-2">Trust and Expertise</h6>
                    ...
                    <div class="col-12  wow fadeInUp">
                        <a href="{{ url('about-us')}}" class="btn btn-primary">More About Us <i class="isax isax-arrow-right-3 ms-2"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="section place-section">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-10 text-center wow fadeInUp" data-wow-delay="0.2s">
                <div class="section-header text-center">
                    <h2 class="mb-2">Popular  <span class="text-primary  text-decoration-underline">Destinations</span></h2>
                    <p class="sub-title">Embark on unforgettable journeys to the world's most sought-after cruise ports</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12 ">
                <div class="destination-set  wow fadeInUp">
                    <div class="destination-img">
                        <img src="{{URL::asset('build/img/destination/destination-07.jpg')}}" alt="Img">
                    </div>
                    ...
                    <div class="destination-btn">
                        <a href="{{ url('cruise-grid')}}"> <i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="destination-set  wow fadeInDown">
                    <div class="destination-img">
                        <img src="{{URL::asset('build/img/destination/destination-08.jpg')}}" alt="Img">
                    </div>
                    <div class="destination-content d-flex align-items-center justify-content-center flex-column w-100">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="destination-set wow fadeInUp">
                    <div class="destination-img">
                        <img src="{{URL::asset('build/img/destination/destination-09.jpg')}}" alt="Img">
                    </div>
                    <div class="destination-content d-flex align-items-center justify-content-center flex-column w-100">
                ...
                <div class="destination-set wow fadeInDown">
                    <div class="destination-img">
                        <img src="{{URL::asset('build/img/destination/destination-10.jpg')}}" alt="Img">
                    </div>
                    <div class="destination-content d-flex align-items-center justify-content-center flex-column w-100">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="destination-set wow fadeInUp">
                    <div class="destination-img">
                        <img src="{{URL::asset('build/img/destination/destination-11.jpg')}}" alt="Img">
                    </div>
                    <div class="destination-content d-flex align-items-center justify-content-center flex-column w-100">
                ...
                <div class="destination-set wow fadeInDown">
                    <div class="destination-img">
                        <img src="{{URL::asset('build/img/destination/destination-12.jpg')}}" alt="Img">
                    </div>
                    <div class="destination-content d-flex align-items-center justify-content-center flex-column w-100">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="destination-set wow fadeInUp">
                    <div class="destination-img">
                        <img src="{{URL::asset('build/img/destination/destination-13.jpg')}}" alt="Img">
                    </div>
                    <div class="destination-content d-flex align-items-center justify-content-center flex-column w-100">
                ...
                <div class="destination-set wow fadeInDown">
                    <div class="destination-img">
                        <img src="{{URL::asset('build/img/destination/destination-14.jpg')}}" alt="Img">
                    </div>
                    <div class="destination-content d-flex align-items-center justify-content-center flex-column w-100">
...
<!-- Client Section -->
<section class="support-company-section bg-primary support-section-five  wow fadeInUp">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="owl-carousel client-slider">
                    <div class="client-img">
                        <img src="{{URL::asset('build/img/clients/client-01.svg')}}" class="img-white" alt="img">
                    </div>
                    <div class="client-img">
                        <img src="{{URL::asset('build/img/clients/client-02.svg')}}" class="img-white" alt="img">
                    </div>
                    <div class="client-img">
                        <img src="{{URL::asset('build/img/clients/client-03.svg')}}" class="img-white" alt="img">
                    </div>
                    <div class="client-img">
                        <img src="{{URL::asset('build/img/clients/client-04.svg')}}" class="img-white" alt="img">
                    </div>
                    <div class="client-img">
                        <img src="{{URL::asset('build/img/clients/client-05.svg')}}" class="img-white" alt="img">
                    </div>
                    <div class="client-img">
                        <img src="{{URL::asset('build/img/clients/client-06.svg')}}" class="img-white" alt="img">
                    </div>
                    <div class="client-img">
                        <img src="{{URL::asset('build/img/clients/client-07.svg')}}" class="img-white" alt="img">
                    </div>
                    <div class="client-img">
                        <img src="{{URL::asset('build/img/clients/client-04.svg')}}" class="img-white" alt="img">
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-10 text-center wow fadeInUp" data-wow-delay="0.2s">
                <div class="section-header text-center">
                    <h2 class="mb-2">Featured <span class="text-primary  text-decoration-underline">Cruises</span></h2>
                    <p class="sub-title">Discover our handpicked selection of top-rated cruises, offering exceptional experiences and unbeatable deals.</p>
                </div>
            </div>
        </div>
        <!-- Cruise List -->
        <div class="owl-carousel place-slider nav-center  wow fadeInUp">
            ...
            <div class="place-item border mb-4">
                ...
                <div class="place-content">
                    <div class="d-flex align-items-center mb-2">
                        <a href="javascript:void(0);" class="d-flex align-items-center me-2">
                            <span class="avatar avatar-xs me-2">
                                <img src="{{URL::asset('build/img/users/user-01.jpg')}}" class="rounded-circle" alt="img">
                            </span>
                            <p class="fs-14">Beth Williams</p>
                        </a>
                        <div class="d-flex align-items-center ps-2 border-start">
                            <span class="badge badge-warning badge-xs text-gray-9 fs-13 fw-medium me-2">5.0</span>
                            <p class="fs-14">(400 Reviews)</p>
                        </div>
                    </div>

                    <h5 class="mb-1"><a href="{{ url('cruise-details')}}">Super Aquamarine</a></h5>
                    <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Ciutat Vella, Barcelona</p>
                    <div class="guest-details">
                        <ul>
                            <li>
                                <h6><i class="isax isax-calendar-2 me-2"></i><span>Year</span> : 2021</h6>
                            </li>
                            <li>
                                <h6><i class="isax isax-fatrows me-2"></i><span>Width</span> : 88.47 m</h6>
                            </li>
                            <li>
                                <h6><i class="isax isax-user me-2"></i><span>Guests </span> : 4</h6>
                            </li>
                            <li>
                                <h6><i class="isax isax-flash me-2"></i><span>Speed </span> : 19 Knots</h6>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="place-content">
                    <div class="d-flex align-items-center mb-2">
                        <a href="javascript:void(0);" class="d-flex align-items-center me-2">
                            ...
                            <p class="fs-14">Brent Holmes</p>
                        </a>
                        <div class="d-flex align-items-center ps-2 border-start">
                            <span class="badge badge-warning badge-xs text-gray-9 fs-13 fw-medium me-2">4.6</span>
                            <p class="fs-14">(520 Reviews)</p>
                        </div>
                    </div>

                    <h5 class="mb-1"><a href="{{ url('cruise-details')}}">Sunny Sailor</a></h5>
                    <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Broad Street, Bristol</p>
                    <div class="guest-details">
                        <ul>
                            <li>
                                <h6><i class="isax isax-calendar-2 me-2"></i><span>Year</span> : 2008</h6>
                            </li>
                            <li>
                                <h6><i class="isax isax-fatrows me-2"></i><span>Width</span> : 64.37 m</h6>
                            </li>
                            <li>
                                <h6><i class="isax isax-user me-2"></i><span>Guests </span> : 4</h6>
                            </li>
                            <li>
                                <h6><i class="isax isax-flash me-2"></i><span>Speed </span> : 18 Knots</h6>
                            </li>
                        </ul>
                    </div>
                    <div class="d-flex align-items-center justify-content-between border-top pt-3">
            ...
            <div class="place-item border mb-4">
                ...
                <div class="place-content">
                    ...
                    <h5 class="mb-1"><a href="{{ url('cruise-details')}}">Ocean Voyager</a></h5>
                    <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Chapel Street, Salford</p>
                    <div class="guest-details">
                        <ul>
                            <li>
                                <h6><i class="isax isax-calendar-2 me-2"></i><span>Year</span> : 2022</h6>
                            </li>
                            <li>
                                <h6><i class="isax isax-fatrows me-2"></i><span>Width</span> : 98.56 m</h6>
                            </li>
                            <li>
                                <h6><i class="isax isax-user me-2"></i><span>Guests </span> : 7</h6>
                            </li>
                            <li>
                                <h6><i class="isax isax-flash me-2"></i><span>Speed </span> : 15 Knots</h6>
                            </li>
                        </ul>
                    </div>
                    <div class="d-flex align-items-center justify-content-between border-top pt-3">
            ...
            <div class="place-item border mb-4">
                ...
                <div class="place-content">
                    ...
                    <h5 class="mb-1"><a href="{{ url('cruise-details')}}">Albert Yacht</a></h5>
                    <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>King’s Road, Chelsea</p>
                    <div class="guest-details">
                        <ul>
                            <li>
                                <h6><i class="isax isax-calendar-2 me-2"></i><span>Year</span> : 2018</h6>
                            </li>
                            <li>
                                <h6><i class="isax isax-fatrows me-2"></i><span>Width</span> : 90.56 m</h6>
                            </li>
                            <li>
                                <h6><i class="isax isax-user me-2"></i><span>Guests </span> : 3</h6>
                            </li>
                            <li>
                                <h6><i class="isax isax-flash me-2"></i><span>Speed </span> : 25 Knots</h6>
                            </li>
                        </ul>
                    </div>
                    <div class="d-flex align-items-center justify-content-between border-top pt-3">
        ...
        <div class="text-center view-all wow fadeInUp">
            <a href="{{ url('cruise-list')}}" class="btn btn-primary">View All<i class="isax isax-arrow-right-3 ms-2"></i></a>
        </div>
    </div>
</section>
<!-- /Cruise Section -->
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="faq-five  wow zoomIn">
                    <img src="{{URL::asset('build/img/faq/faq.png')}}" alt="img">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row justify-content-center">
                ...
                <div class="accordion accordion-flush faq-accordion-five" id="accordionFaq">
                    <div class="accordion-item show mb-3 wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                    ...
                    <div class="accordion-item mb-3 wow fadeInUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                        <h2 class="accordion-header">
                    ...
                    <div class="accordion-item mb-3  wow fadeInUp" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                        <h2 class="accordion-header">
                    ...
                    <div class="accordion-item mb-3 wow fadeInUp" data-wow-delay="0.8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">
                        <h2 class="accordion-header">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-10 text-center">
                <div class="section-header text-center  wow fadeInUp">
                    ...
                    <p class="sub-title">Explore heartfelt stories from our satisfied travelers, showcasing unforgettable journeys and remarkable memories</p>
                </div>
            </div>
        </div>
        <div class="owl-carousel testimonial-slider">
            ...
            <div class="card border-white wow fadeInUp" data-wow-delay="0.2s">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between text-center flex-column">
                        <div class="rating d-flex align-items-center me-2 mb-3">
                        ...
                        <h6 class="mb-2">A Dream Vacation Come True!</h6>
                        <p class="mb-3">Dream Tours is the only way to go. We had the time of our life on our trip to the Ark. The customer service was wonderful, and the staff was very helpful.</p>
                        <div class="d-flex align-items-center">
            ...
            <div class="card border-white wow fadeInUp" data-wow-delay="0.2s">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between text-center flex-column">
                        ...
                        <h6 class="mb-2">Perfect Family Getaway!</h6>
                        <p class="mb-3">We had a fantastic time as a family. There were activities for every age group, and the kids loved the onboard kids’ club. The cruise gave us the perfect relaxation & fun.</p>
                        <div class="d-flex align-items-center">
                            <a href="javascript:void(0);" class="avatar avatar-md  flex-shrink-0">
                                <img src="{{URL::asset('build/img/users/user-02.jpg')}}" class="rounded-circle" alt="img">
                            </a>
            ...
            <div class="card border-white wow fadeInUp" data-wow-delay="0.2s">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between flex-column">
                        <div class="rating d-flex align-items-center me-2 mb-3">
                            <i class="fa-solid fa-star filled  text-primary me-1"></i>
                            <i class="fa-solid fa-star filled  text-primary me-1"></i>
                            <i class="fa-solid fa-star filled  text-primary me-1"></i>
                            <i class="fa-solid fa-star filled  text-primary me-1"></i>
                            <i class="fa-solid fa-star filled  text-primary me-1"></i>
                        ...
                        <h6 class="mb-1">Amazing Food and Entertainment!</h6>
                        <p class="mb-3"> was blown away by the variety of dining options and live shows every night. It felt like I was in a five-star hotel on the sea! I’m already planning my next cruise</p>
                        <div class="d-flex align-items-center">
                            <a href="javascript:void(0);" class="avatar avatar-md  flex-shrink-0">
                                <img src="{{URL::asset('build/img/users/user-03.jpg')}}" class="rounded-circle" alt="img">
                            </a>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="getintouch-content pe-0">
                                ...
                                <p class="text-light mb-4">Have questions about destinations, onboard experiences, or special offers? Our team is here to guide you. Reach out and let's make your next adventure unforgettable!</p>
                                <a href="{{ url('contact-us')}}" class="btn btn-white">Contact Us<i class="isax isax-arrow-right-3 ms-2"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="getintouch-img">
                                <img src="{{URL::asset('build/img/cruise/cruise-23.jpg')}}" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
