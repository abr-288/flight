    ...
    <div class="container">
        <div class="place-nav">
            <ul class="nav" role="tablist">
                <li>
                    <a href="javascript:void(0);" class="nav-link active" data-bs-toggle="tab" data-bs-target="#add_cruise" aria-selected="true" role="tab">
                        Edit Cruise
                    </a>
                </li>
                <li>
                        ...
                        <form action="{{url('cruise-grid')}}">
                            ...
                            <div class="card shadow-none" id="itenary">
                                ...
                                <div class="card-body">
                                    <div class="card shadow-none mb-3">
                                        <div class="card-body px-3 py-2">
                                            <div class=" d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                                <h6><a href="javascript:void(0);">Day 1, Kickoff in Los Angeles</a></h6>
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="rounded-edit d-flex align-items-center justify-content-center me-2">
                                    ...
                                    <div>
                                        <a href="javascript:void(0);" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#add_iternary">
