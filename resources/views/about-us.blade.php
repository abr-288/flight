            ...
            <div class="row">
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="team-item wow fadeInUp" data-wow-delay="0.2s">
                        <div class="card">
                            <div class="card-body">
                                <img src="{{URL::asset('build/img/users/user-17.jpg')}}" alt="Img" class="img-fluid">
                            </div>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="team-item wow fadeInUp" data-wow-delay="0.2s">
                        <div class="card">
                            <div class="card-body">
                                <img src="{{URL::asset('build/img/users/user-18.jpg')}}" alt="Img" class="img-fluid">
                            </div>
                            <div class="team-overlay">
                                <div class="bg-white py-2 px-3 rounded-pill  text-center">
                                    <h5>Morgan Owen</h5>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="team-item wow fadeInUp" data-wow-delay="0.2s">
                        <div class="card">
                            <div class="card-body">
                                <img src="{{URL::asset('build/img/users/user-19.jpg')}}" alt="Img" class="img-fluid">
                            </div>
                            <div class="team-overlay">
                                <div class="bg-white py-2 px-3 rounded-pill  text-center">
                                    <h5>Richard Dolen</h5>
